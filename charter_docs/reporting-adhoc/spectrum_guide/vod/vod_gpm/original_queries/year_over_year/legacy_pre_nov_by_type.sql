INSERT INTO TABLE test.vod_views_monthly_legacy
...
(         SELECT LAST_DAY(partition_date_time) AS month_of,
         ...
         WHERE partition_date_time BETWEEN '2016-05-01' AND LAST_DAY('2016-05-01')
