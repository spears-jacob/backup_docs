...
aws s3 cp s3://pi-global-${ENVIRONMENT}-udf-jars/aws_common_utilities_1.1.jar ./scripts
jar -xf ./scripts/aws_common_utilities_1.1.jar
...
REPORT_NAME="MSA Customer Experience"
