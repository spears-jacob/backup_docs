...
--drop table IF EXISTS asp_extract_login_data_daily_2months;
CREATE TABLE IF NOT EXISTS asp_extract_login_data_daily_2months (
...
;
INSERT INTO TABLE asp_extract_login_data_daily_2months PARTITION (date_denver)
...
drop table if EXISTS asp_extract_login_data_daily_2months_pvt;
CREATE TABLE IF NOT EXISTS asp_extract_login_data_daily_2months_pvt AS
Select  account_number,
...
from (select  account_number,
              ...
              case when application_name = 'SpecMobile' then date_denver else null end as specmobile,
              date_denver,
              division_id,
              site_sys,
              prn,
              ...
              acct_company,
              acct_franchise
      from asp_extract_login_data_daily_2months
...
SELECT '***** data insert into asp_extract_login_data_daily_2months_pvt complete ******'
;
