...
export report_table_where_field2=${30}
export report_table_where_field3=${31}
export report_table_where_field4=${32}
export report_table_where_value1=${33}
export report_table_where_value2=${34}
export report_table_where_value3=${35}
export report_table_where_value4=${36}
export csv_file_select1=${37}
export csv_file_select2=${38}
export csv_file_select3=${39}
...
if [ "$RUN_DATE" != "" ]; then
  ...
  SELECT $report_table_counted_field
  FROM $report_table
 WHERE $report_table_date_field rlike '${data_date}.*'
  AND $report_table_where_field1 = '$report_table_where_value1'
  AND $report_table_where_field2 = '$report_table_where_value2'
  AND $report_table_where_field3 = '$report_table_where_value3'
  AND $report_table_where_field4 = '$report_table_where_value4'
  AND $report_table_counted_field is not null
  ;

  "
  data_cnt=$(hive -e "set hive.cli.print.header=false; USE $ENVIRONMENT; SELECT $report_table_counted_field FROM $report_table WHERE $report_table_date_field rlike '${data_date}.*' AND $report_table_where_field1 = '$report_table_where_value1' AND $report_table_where_field2 = '$report_table_where_value2' AND $report_table_where_field3 = '$report_table_where_value3' AND $report_table_where_field4 = '$report_table_where_value4' AND $report_table_counted_field is not null;");
  if [ -z "$data_cnt" ]
  then
      echo "\$data_cnt is empty"
      data_cnt=0
  else
...
if [ ${data_cnt[0]} -gt 0 ]; then
  ...
  #
  #  → head -4 WeeklyMetricsTab.csv
  #
  #  Feature,Metric,Name W Total,Portal,Week End Dt,s.%_Success (string),s.Metric Value Formatted (string)
  #  Overall Metrics,  Total,Total - Unique Households [Authenticated],     ,2019-02-08,,"2,125,231"
  #  Overall Metrics,  Total,Total - Unique Households [Authenticated],     ,2019-02-15,,"1,943,862"
  #  Overall Metrics,  Total,Total - Unique Households [Authenticated],     ,2019-02-22,,"1,974,971"
  ...
  export SecondLineOfCheckingView=$(cat $tab_ck_vw | grep $data_date | grep -i  $csv_file_select1 | grep -i $csv_file_select2 | grep -i $csv_file_select3| sed -n '1 p' | sed 's/"//g')
  ...
  for index in "${!metric_checking_array[@]}"
    ...
    export TotalMetricCount="${metric_checking_array[6]}${metric_checking_array[7]}${metric_checking_array[8]}${metric_checking_array[9]}"
    export ThresholdMatch="${data_cnt[0]}"
    ...
    if [ "$TotalMetricCount" == "$ThresholdMatch" ]; then echo "
      ...
      echo report_table_where_field3=$report_table_where_field3
      echo report_table_where_field4=$report_table_where_field4
      echo report_table_where_value1=$report_table_where_value1
      echo report_table_where_value2=$report_table_where_value2
      echo report_table_where_value3=$report_table_where_value3
      echo report_table_where_value4=$report_table_where_value4
      echo csv_file_select1=$csv_file_select1
      echo csv_file_select2=$csv_file_select2
      echo csv_file_select3=$csv_file_select3
