...
SET domain=smb;
SET adobe=asp_metric_pivot_smb_adobe_wk;
SET quantum=asp_metric_pivot_smb_quantum_wk;
SET lkp=${env:LKP_db}.asp_pm_metric_lkp;
SET nulls=asp_pm_smb_adobe_np;
SET report=Prod_Weekly;
SET uniraw=asp_v_pm_smb_unified_raw;
SET adobe_stg=asp_prod_weekly_smb_adobe_stage;
SET quantum_stg=asp_prod_weekly_smb_quantum_stage;
SET stage=asp_prod_weekly_smb_stage;
SET format=asp_prod_weekly_smb;
SET tab=asp_v_prod_weekly_smb_tab;
