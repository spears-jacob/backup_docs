...
SET domain=smb;
SET adobe=asp_metric_pivot_smb_adobe_daily;
SET quantum=asp_metric_pivot_smb_quantum_daily;
SET lkp=${env:LKP_db}.asp_pm_metric_lkp;
SET nulls=asp_ops_daily_smb_adobe_np;
SET report=Prod_Monthly;
SET uniraw=asp_v_ops_daily_smb_unified_raw;
SET adobe_stg=asp_ops_daily_smb_adobe_stage;
SET quantum_stg=asp_ops_daily_smb_quantum_stage;
SET stage=asp_ops_daily_smb_stage;
SET format=asp_ops_daily_smb;
SET tab=asp_v_ops_daily_smb_tab;
