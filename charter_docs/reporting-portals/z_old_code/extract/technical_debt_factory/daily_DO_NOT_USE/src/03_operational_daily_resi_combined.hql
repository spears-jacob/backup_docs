...
SET domain=resi;
SET adobe=asp_metric_pivot_resi_adobe_daily;
SET quantum=asp_metric_pivot_resi_quantum_daily;
SET lkp=${env:LKP_db}.asp_pm_metric_lkp;
SET nulls=asp_ops_daily_resi_adobe_np;
SET report=Prod_Monthly;
SET uniraw=asp_v_ops_daily_resi_unified_raw;
SET adobe_stg=asp_ops_daily_resi_adobe_stage;
SET quantum_stg=asp_ops_daily_resi_quantum_stage;
SET stage=asp_ops_daily_resi_stage;
SET format=asp_ops_daily_resi;
SET tab=asp_v_ops_daily_resi_tab;
