...
SELECT '\n\nNow clearing asp_net_${env:CADENCE}_agg_totals...\n\n';
TRUNCATE TABLE asp_net_${env:CADENCE}_agg_totals;

SELECT '\n\nNow selecting Total Combined for every metric from ${env:adj} into asp_net_${env:CADENCE}_agg_totals...\n\n';


INSERT INTO TABLE asp_net_${env:CADENCE}_agg_totals
...
SELECT '\n\nNow Staging non-Total Combined data for every metric from ${env:adj} into asp_net_${env:CADENCE}_agg_totals...\n\n';
