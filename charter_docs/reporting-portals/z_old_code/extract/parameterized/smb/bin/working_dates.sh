...
if   [ $3 -eq 1 ]; then
  ...
  export apl="date_yearmonth(partition_date)";
  ...
  export adj="asp_sb_monthly_agg_raw_adj"
  ...
  export aplh=$apl;
  export adj="asp_sb_fiscal_monthly_agg_raw_adj"
  export ape="(epoch_converter(cast(message__timestamp*1000 as bigint),\\\\\\\"$1\\\\\\\"))";
  ...
  export apl="partition_date";
  export ape="(epoch_converter(cast(message__timestamp*1000 as bigint),\\\\\\\"$1\\\\\\\"))";
  export ap="$ape"
  export adj="asp_sb_daily_agg_raw"
