Readme file for asp_sb_agg

SYNOPSIS:
The asp_sb_agg project uses several variables to handle different processing scenarios
found in the project.properties and in the output of the working_dates shell script.
Please see 03_asp_sb_agg.job for instructions regarding manual entries and adjustments.
...
-- --------------------------------------------              --------------------------------               -------------------
-- a percent_account_creation_success_off_chtr_network       new_accounts_created_off_chtr_network          new_account_creation_attempts_off_chtr_network
-- b percent_account_creation_success_on_chtr_network        new_accounts_created_on_chtr_network           new_account_creation_attempts_on_chtr_network
-- c percent_auto_pay_success                                auto_pay_setup_successes                       auto_pay_setup_attempts
-- d percent_hhs_logged_in                                   hhs_logged_in                                  total_hhs
-- e percent_login_success                                   total_login_successes                          total_login_attempts
-- f percent_one_time_payment_success                        one_time_payments                              one_time_payment_attempts
-- g percent_password_reset_success_off_chtr_network         successful_password_resets_off_chtr_network    attempts_to_reset_password_off_chtr_network
-- h percent_total_password_reset_success                    total_successful_password_resets               total_attempts_to_reset_password
-- i percent_sub_user_creation_success_off_chtr_network      sub_users_created_off_chtr_network             sub_user_creation_attempts_off_chtr_network
-- j percent_sub_user_creation_success_on_chtr_network       sub_users_created_on_chtr_network              sub_user_creation_attempts_on_chtr_network
-- k percent_total_account_creation_success                  total_new_accounts_created                     total_account_creation_attempts
-- m percent_total_sub_user_creation_success                 total_new_sub_users_created                    total_sub_user_creation_attempts
-- n percent_total_success_recover_reset_username_password   total_username_recovery_successes              total_username_recovery_attempts
-- o percent_username_recovery_success_off_chtr_network      username_recovery_successes_off_chtr_network   username_recovery_attempts_off_chtr_network
-- p percent_username_recovery_success_on_chtr_network       username_recovery_successes_on_chtr_network    username_recovery_attempts_on_chtr_network
-- q bounce_rate_Login                                       bounces_Login                                  entries_Login
