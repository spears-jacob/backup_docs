...
if   [ $3 -eq 1 ]; then
  ...
  export ymd="year_month_Denver";
  export afp="date_yearmonth(partition_date_denver)";
  ...
  export adj="asp_app_monthly_agg_raw_adj"
  ...
  export ymd="year_fiscal_month_Denver";
  export afp="fiscal_month";
  export adj="asp_app_fiscal_monthly_agg_raw_adj"
  export ape="(epoch_converter(cast(message__timestamp*1000 as bigint),\\\\\\\"$1\\\\\\\"))";
  export ap="fiscal_month";
  echo -e "\n\nNow processing using a cadence of Charter FISCAL MONTH (22nd prior to 21st current month) using $LKP_db.${fm_lkp}.\n\n";
  ...
  export ymd="date_Denver";
  export afp="partition_date_denver";
  export ape="(epoch_converter(cast(message__timestamp*1000 as bigint),\\\\\\\"$1\\\\\\\"))";
  export ap="$ape"
  export adj="asp_app_daily_agg_raw"
