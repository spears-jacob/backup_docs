...
PARTITION(unit,platform,domain,company,date_denver,source_table)
    ...
    FROM (SELECT  company,
          ...
          FROM ${env:TMP_db}.asp_venona_counts_daily_counts_visits_columns
        ) as derived_table
