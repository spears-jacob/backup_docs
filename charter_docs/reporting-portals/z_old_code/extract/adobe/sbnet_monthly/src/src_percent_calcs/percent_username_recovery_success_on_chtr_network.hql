...
-- preforms percent calculations for percent_username_recovery_success_on_chtr_network metric
...
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin percent_username_recovery_success_on_chtr_network metric calculation insert by company --
...
'percent_username_recovery_success_on_chtr_network' AS metric
FROM
(SELECT
    tab.company,
    '${env:YEAR_MONTH}' AS year_month,
    ...
    LEFT JOIN
        ...
        WHERE
        metric = 'username_recovery_successes_on_chtr_network'
    ...
    LEFT JOIN
        ...
        sbnet_exec_monthly_tableau
        WHERE
        metric = 'username_recovery_attempts_on_chtr_network'
        AND year_month = '${env:YEAR_MONTH}'
        AND company <> 'Total Combined'
        GROUP BY
        year_month,
    ...
    AND tab.metric = 'percent_username_recovery_success_on_chtr_network'
...
SELECT '*****-- End percent_username_recovery_success_on_chtr_network metric calculation insert by company --*****'
;

-- End percent_username_recovery_success_on_chtr_network metric calculation insert by company --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin percent_username_recovery_success_on_chtr_network metric calculation insert by company --
...
SELECT '*****-- End percent_username_recovery_success_on_chtr_network metric calculation insert by Total Combined --*****'
;

-- End percent_username_recovery_success_on_chtr_network metric calculation insert by Total Combined --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------