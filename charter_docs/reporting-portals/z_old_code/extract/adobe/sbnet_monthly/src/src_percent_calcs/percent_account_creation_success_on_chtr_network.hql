...
-- preforms percent calculations for percent_account_creation_success_on_chtr_network metric
...
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin percent_account_creation_success_on_chtr_network metric calculation insert by company --
...
'percent_account_creation_success_on_chtr_network' AS metric
FROM
(SELECT
    tab.company,
    '${env:YEAR_MONTH}' AS year_month,
    ...
    LEFT JOIN
        ...
        WHERE
        metric = 'new_accounts_created_on_chtr_network'
    ...
    LEFT JOIN
        ...
        sbnet_exec_monthly_tableau
        WHERE
        metric = 'new_account_creation_attempts_on_chtr_network'
        AND year_month = '${env:YEAR_MONTH}'
        AND company <> 'Total Combined'
        GROUP BY
        year_month,
    ...
    AND tab.metric = 'percent_account_creation_success_on_chtr_network'
...
SELECT '*****-- End percent_account_creation_success_on_chtr_network metric calculation insert by company --*****'
;

-- End percent_account_creation_success_on_chtr_network metric calculation insert by company --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin percent_account_creation_success_on_chtr_network metric calculation insert by company --
...
SELECT '*****-- End percent_account_creation_success_on_chtr_network metric calculation insert by Total Combined --*****'
;

-- End percent_account_creation_success_on_chtr_network metric calculation insert by Total Combined --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------