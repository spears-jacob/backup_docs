...
-- performs percent calculations for percent_total_sub_user_creation_success metric
...
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin percent_total_sub_user_creation_success metric calculation insert by company --
...
'percent_total_sub_user_creation_success' AS metric
FROM
(SELECT
    tab.company,
    '${env:YEAR_MONTH}' AS year_month,
    ...
    LEFT JOIN
        ...
        WHERE
        metric = 'total_new_sub_users_created'
    ...
    LEFT JOIN
        ...
        sbnet_exec_monthly_tableau
        WHERE
        metric = 'total_sub_user_creation_attempts'
        AND year_month = '${env:YEAR_MONTH}'
        AND company <> 'Total Combined'
        GROUP BY
        year_month,
    ...
    AND tab.metric = 'percent_total_sub_user_creation_success'
...
SELECT '*****-- End percent_total_sub_user_creation_success metric calculation insert by company --*****'
;

-- End percent_total_sub_user_creation_success metric calculation insert by company --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin percent_total_sub_user_creation_success metric calculation insert by company --
...
SELECT '*****-- End percent_total_sub_user_creation_success metric calculation insert by Total Combined --*****'
;

-- End percent_total_sub_user_creation_success metric calculation insert by Total Combined --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
