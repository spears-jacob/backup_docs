...
-- preforms percent calculations for percent_password_reset_success_off_chtr_network metric
...
(SELECT
    ...
    LEFT JOIN
        ...
        WHERE
        metric = 'successful_password_resets_off_chtr_network'
    ...
    LEFT JOIN
        ...
        sbnet_exec_monthly_tableau
        WHERE
        metric = 'attempts_to_reset_password_off_chtr_network'
        AND year_month = '${env:YEAR_MONTH}'
        AND company <> 'Total Combined'
        GROUP BY
        year_month,
