...
echo "### Running percent_total_sub_user_creation_success job for  start date $MONTH_START_DATE, end date $MONTH_END_DATE"
hive -f src/src_percent_calcs/percent_total_sub_user_creation_success.hql || exit 1 
echo "### Completed the percent_total_sub_user_creation_success job...."
