...
echo "### Running unique_hhs_3month_change job for  start date $MONTH_START_DATE, end date $MONTH_END_DATE"
hive -f src/src_percent_calcs/unique_hhs_3month_change.hql || exit 1 
echo "### Completed the unique_hhs_3month_change job...."
