...
echo "### Running percent_sub_user_creation_success_on_chtr_network job for  start date $MONTH_START_DATE, end date $MONTH_END_DATE"
hive -f src/src_percent_calcs/percent_sub_user_creation_success_on_chtr_network.hql || exit 1 
echo "### Completed the percent_sub_user_creation_success_on_chtr_network job...."
