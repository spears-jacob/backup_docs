...
echo "### Running net_percents_combined_monthly job for  start date $MONTH_START_DATE, end date $MONTH_END_DATE"
hive -f src/src_percent_calcs/sbnet_percents_combined_monthly.hql || exit 1 
echo "### Completed the net_percents_combined_monthly job...."
