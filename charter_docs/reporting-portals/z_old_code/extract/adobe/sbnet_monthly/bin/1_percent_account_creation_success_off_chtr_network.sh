...
echo "### Running percent_account_creation_success_off_chtr_network job for  start date $MONTH_START_DATE, end date $MONTH_END_DATE"
hive -f src/src_percent_calcs/percent_account_creation_success_off_chtr_network.hql || exit 1 
echo "### Completed the percent_account_creation_success_off_chtr_network job...."
