...
echo "### Running percent_hhs_logged_in job for  start date $MONTH_START_DATE, end date $MONTH_END_DATE"
hive -f src/src_percent_calcs/percent_hhs_logged_in.hql || exit 1 
echo "### Completed the percent_hhs_logged_in job...."
