...
echo "### Running percent_calcs_stage job for  start date $MONTH_START_DATE, end date $MONTH_END_DATE"
hive -f src/src_percent_calcs/1_percent_calcs_stage.hql || exit 1 
echo "### Completed the percent_calcs_stage job...."
