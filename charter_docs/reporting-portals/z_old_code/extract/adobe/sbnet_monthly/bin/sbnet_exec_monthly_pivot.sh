...
echo "### Running sbnet_exec_monthly_pivot job for  start date $MONTH_START_DATE, end date $MONTH_END_DATE"
hive -f src/sbnet_exec_monthly_pivot.hql || exit 1 
echo "### Completed the sbnet_exec_monthly_pivot job...."
