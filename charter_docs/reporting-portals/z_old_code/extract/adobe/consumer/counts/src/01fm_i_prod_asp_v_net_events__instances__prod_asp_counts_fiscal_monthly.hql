...
CREATE TEMPORARY TABLE ${env:TMP_db}.asp_counts_fiscal_monthly_counts_instances_columns AS
    SELECT
        ...
        SUM(IF( visit__settings['post_prop48'] IN ('https://www.spectrum.net/forgot/#/password?SourceApp=MSA'), 1, 0)) AS forgot_password_referred_from_msa,
...
PARTITION(unit,platform,domain,company,year_fiscal_month_denver,source_table)
    ...
    FROM (SELECT  company,
                  ...
                  MAP(
                      ...
                      'forgot_password_referred_from_msa|Forgot Password Referral From MySpectrum App|Spectrum.net_adobe||', forgot_password_referred_from_msa,
