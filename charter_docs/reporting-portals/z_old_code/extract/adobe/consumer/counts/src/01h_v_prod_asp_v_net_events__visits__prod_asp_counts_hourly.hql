...
CREATE TEMPORARY TABLE ${env:TMP_db}.asp_counts_hourly_counts_visits_columns AS
    SELECT
        ...
        SIZE(COLLECT_SET(IF( visit__settings['post_prop48'] IN ('https://www.spectrum.net/forgot/#/password?SourceApp=MSA'), visit__visit_id, Null))) AS forgot_password_referred_from_msaID/Auth_visits,
...
PARTITION(unit,platform,domain,company,date_denver,source_table)
    ...
    FROM (SELECT  company,
                  ...
                  MAP(
                      ...
                      'forgot_password_referred_from_msa|Forgot Password Referral From MySpectrum App|Spectrum.net_adobe|ID/Auth|', forgot_password_referred_from_msaID/Auth_visits,
