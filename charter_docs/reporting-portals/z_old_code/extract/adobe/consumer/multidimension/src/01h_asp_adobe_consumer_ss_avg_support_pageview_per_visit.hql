...
FROM
      (SELECT
            ...
            SUM(IF( message__category = 'Page View'
                ...
                and LOWER(state__view__current_page__name) != 'search-results.spectrum'
                AND LOWER(state__view__current_page__name) != 'search-results.google'
                AND LOWER(state__view__current_page__name) != 'support',
      ...
      WHERE (partition_date >= '${env:START_DATE}'
        AND partition_date < '${env:END_DATE_TZ}')
