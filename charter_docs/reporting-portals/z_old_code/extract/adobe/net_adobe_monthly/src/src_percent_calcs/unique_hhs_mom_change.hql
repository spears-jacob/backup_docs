...
-- performs percent calculations for unique_hhs_mom_change metric
...
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin unique_hhs_mom_change metric calculation insert by company --
...
(SELECT
    ...
    AND tab.metric = 'unique_hhs_mom_change'
...
SELECT '*****-- End unique_hhs_mom_change metric calculation insert by company --*****'
;

-- End unique_hhs_mom_change metric calculation insert by company --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin unique_hhs_mom_change metric calculation insert by company --
...
SELECT '*****-- End unique_hhs_mom_change metric calculation insert by Total Combined --*****'
;

-- End unique_hhs_mom_change metric calculation insert by Total Combined --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------