...
-- performs percent calculations for percent_auto_pay_success metric
...
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin percent_auto_pay_success metric calculation insert by company --
...
'percent_auto_pay_success' AS metric
FROM
(SELECT
    tab.company,
    '${env:YEAR_MONTH}' AS year_month,
    ...
    LEFT JOIN
        ...
        WHERE
        metric = 'successful_autopay_confirm_count'
    ...
    AND tab.metric = 'percent_auto_pay_success'
...
SELECT '*****-- End percent_auto_pay_success metric calculation insert by company --*****'
;

-- End percent_auto_pay_success metric calculation insert by company --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin percent_auto_pay_success metric calculation insert by company --
...
SELECT '*****-- End percent_auto_pay_success metric calculation insert by Total Combined --*****'
;

-- End percent_auto_pay_success metric calculation insert by Total Combined --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------