...
-- performs percent calculations for percent_new_ids_charter_count_on_net metric
...
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin percent_new_ids_charter_count_on_net metric calculation insert by company --
...
'percent_new_ids_charter_count_on_net' AS metric
FROM
(SELECT
    tab.company,
    '${env:YEAR_MONTH}' AS year_month,
    ...
    LEFT JOIN
        ...
        net_products_agg_monthly_tableau
        WHERE
        metric = 'attempts_create_id_count_on_net'
        AND year_month = '${env:YEAR_MONTH}'
        AND company <> 'Total Combined'
        GROUP BY
        year_month,
    ...
    AND tab.metric = 'percent_new_ids_charter_count_on_net'
...
SELECT '*****-- End percent_new_ids_charter_count_on_net metric calculation insert by company --*****'
;

-- End percent_new_ids_charter_count_on_net metric calculation insert by company --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin percent_new_ids_charter_count_on_net metric calculation insert by company --
...
SELECT '*****-- End percent_new_ids_charter_count_on_net metric calculation insert by Total Combined --*****'
;

-- End percent_new_ids_charter_count_on_net metric calculation insert by Total Combined --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------