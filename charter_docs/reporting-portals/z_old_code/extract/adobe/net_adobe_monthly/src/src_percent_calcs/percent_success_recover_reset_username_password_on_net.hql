...
-- performs percent calculations for percent_success_recover_reset_username_password_on_net metric
...
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin percent_success_recover_reset_username_password_on_net metric calculation insert by company --
...
'percent_success_recover_reset_username_password_on_net' AS metric
FROM
(SELECT
    tab.company,
    '${env:YEAR_MONTH}' AS year_month,
    ...
    LEFT JOIN
        ...
        WHERE
        metric = 'successfully_recover_username_password_count_on_net'
    ...
    LEFT JOIN
        ...
        net_products_agg_monthly_tableau
        WHERE
        metric = 'attempts_recover_username_password_count_on_net'
        AND year_month = '${env:YEAR_MONTH}'
        AND company <> 'Total Combined'
        GROUP BY
        year_month,
    ...
    AND tab.metric = 'percent_success_recover_reset_username_password_on_net'
...
SELECT '*****-- End percent_success_recover_reset_username_password_on_net metric calculation insert by company --*****'
;

-- End percent_success_recover_reset_username_password_on_net metric calculation insert by company --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin percent_success_recover_reset_username_password_on_net metric calculation insert by company --
...
SELECT '*****-- End percent_success_recover_reset_username_password_on_net metric calculation insert by Total Combined --*****'
;

-- End percent_success_recover_reset_username_password_on_net metric calculation insert by Total Combined --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------