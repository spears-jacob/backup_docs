...
-- performs percent calculations for percent_total_success_recover_reset_username_password metric
...
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin percent_total_success_recover_reset_username_password metric calculation insert by company --
...
'percent_total_success_recover_reset_username_password' AS metric
FROM
(SELECT
    tab.company,
    '${env:YEAR_MONTH}' AS year_month,
    ...
    LEFT JOIN
        ...
        WHERE
        metric = 'successfully_recover_username_password_count_all'
    ...
    LEFT JOIN
        ...
        net_products_agg_monthly_tableau
        WHERE
        metric = 'attempts_recover_username_password_count_all'
        AND year_month = '${env:YEAR_MONTH}'
        AND company <> 'Total Combined'
        GROUP BY
        year_month,
    ...
    AND tab.metric = 'percent_total_success_recover_reset_username_password'
...
SELECT '*****-- End percent_total_success_recover_reset_username_password metric calculation insert by company --*****'
;

-- End percent_total_success_recover_reset_username_password metric calculation insert by company --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin percent_total_success_recover_reset_username_password metric calculation insert by company --
...
SELECT '*****-- End percent_total_success_recover_reset_username_password metric calculation insert by Total Combined --*****'
;

-- End percent_total_success_recover_reset_username_password metric calculation insert by Total Combined --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------