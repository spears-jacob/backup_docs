...
-- performs percent calculations for percent_id_recovery_success_off_chtr_network metric
...
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin percent_id_recovery_success_off_chtr_network metric calculation insert by company --
...
'percent_id_recovery_success_off_chtr_network' AS metric
FROM
(SELECT
    tab.company,
    '${env:YEAR_MONTH}' AS year_month,
    ...
    LEFT JOIN
        ...
        WHERE
        metric = 'successful_username_recovery_count_off_net'
    ...
    LEFT JOIN
        ...
        net_products_agg_monthly_tableau
        WHERE
        metric = 'attempts_recover_username_count_off_net'
        AND year_month = '${env:YEAR_MONTH}'
        AND company <> 'Total Combined'
        GROUP BY
        year_month,
    ...
    AND tab.metric = 'percent_id_recovery_success_off_chtr_network'
...
SELECT '*****-- End percent_id_recovery_success_off_chtr_network metric calculation insert by company --*****'
;

-- End percent_id_recovery_success_off_chtr_network metric calculation insert by company --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin percent_id_recovery_success_off_chtr_network metric calculation insert by company --
...
SELECT '*****-- End percent_id_recovery_success_off_chtr_network metric calculation insert by Total Combined --*****'
;

-- End percent_id_recovery_success_off_chtr_network metric calculation insert by Total Combined --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------