...
-- performs percent calculations for percent_one_time_payment_success metric
...
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin percent_one_time_payment_success metric calculation insert by company --
...
'percent_one_time_payment_success' AS metric
FROM
(SELECT
    tab.company,
    '${env:YEAR_MONTH}' AS year_month,
    ...
    LEFT JOIN
        ...
        WHERE
        metric = 'one_time_payments_confirm_count'
    ...
    AND tab.metric = 'percent_one_time_payment_success'
...
SELECT '*****-- End percent_one_time_payment_success metric calculation insert by company --*****'
;

-- End percent_one_time_payment_success metric calculation insert by company --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
-- Begin percent_one_time_payment_success metric calculation insert by company --
...
SELECT '*****-- End percent_one_time_payment_success metric calculation insert by Total Combined --*****'
;

-- End percent_one_time_payment_success metric calculation insert by Total Combined --
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------