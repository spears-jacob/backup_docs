...
echo "### Running net_products_agg_monthly_billpay job for  start date $MONTH_START_DATE, end date $MONTH_END_DATE"
hive -f src/net_products_agg_monthly_billpay.hql || exit 1 
echo "### Completed the net_products_agg_monthly_billpay job...."
