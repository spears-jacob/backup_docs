...
echo "### Running percent_success_new_ids_charter_off_net job for  start date $MONTH_START_DATE, end date $MONTH_END_DATE"
hive -f src/src_percent_calcs/percent_success_new_ids_charter_off_net.hql || exit 1 
echo "### Completed the percent_success_new_ids_charter_off_net job...."
