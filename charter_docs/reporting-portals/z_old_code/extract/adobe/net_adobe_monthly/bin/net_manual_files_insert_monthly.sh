...
echo "### Running net_manual_files_insert_monthly job for  start date $MONTH_START_DATE, end date $MONTH_END_DATE"
hive -f src/net_manual_files_insert_monthly.hql || exit 1 
echo "### Completed the net_manual_files_insert_monthly job...."
