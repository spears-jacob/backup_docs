...
echo "### Running percent_total_create_id_count_all job for  start date $MONTH_START_DATE, end date $MONTH_END_DATE"
hive -f src/src_percent_calcs/percent_total_create_id_count_all.hql || exit 1 
echo "### Completed the percent_total_create_id_count_all job...."
