...
echo "### Running net_adjustments_combined_monthly job for  start date $MONTH_START_DATE, end date $MONTH_END_DATE"
hive -f src/net_adjustments_combined_monthly.hql || exit 1 
echo "### Completed the net_adjustments_combined_monthly job...."
