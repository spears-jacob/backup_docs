...
echo "### Running net_monthly_agg_totals job for  start date $MONTH_START_DATE, end date $MONTH_END_DATE"
hive -f src/net_monthly_agg_totals.hql || exit 1 
echo "### Completed the net_monthly_agg_totals job...."
