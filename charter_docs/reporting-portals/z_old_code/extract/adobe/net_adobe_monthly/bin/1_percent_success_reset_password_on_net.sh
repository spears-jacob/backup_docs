...
echo "### Running percent_success_reset_password_on_net job for  start date $MONTH_START_DATE, end date $MONTH_END_DATE"
hive -f src/src_percent_calcs/percent_success_reset_password_on_net.hql || exit 1 
echo "### Completed the percent_success_reset_password_on_net job...."
