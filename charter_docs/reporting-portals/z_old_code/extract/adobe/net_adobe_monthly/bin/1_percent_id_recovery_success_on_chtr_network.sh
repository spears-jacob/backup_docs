...
echo "### Running percent_id_recovery_success_on_chtr_network job for  start date $MONTH_START_DATE, end date $MONTH_END_DATE"
hive -f src/src_percent_calcs/percent_id_recovery_success_on_chtr_network.hql || exit 1 
echo "### Completed the percent_id_recovery_success_on_chtr_network job...."
