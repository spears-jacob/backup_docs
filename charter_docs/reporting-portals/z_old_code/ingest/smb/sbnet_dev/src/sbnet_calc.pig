...
raw_sbnet = LOAD '$TMP_db.sbnet_dev_denorm' USING org.apache.hive.hcatalog.pig.HCatLoader();
...
STORE raw_sbnet_calc_f INTO '$TMP_db.sbnet_dev_calc' USING org.apache.hive.hcatalog.pig.HCatStorer();
