...
raw_sbnet = LOAD '$TMP_db.sbnet_dev_raw' USING org.apache.hive.hcatalog.pig.HCatLoader();

-- loading of the tables
--Following tables are adobe generated
map_browser = LOAD '$LKP_db.sbnet_dev_browser' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_country = LOAD '$LKP_db.sbnet_dev_country' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_connection_type = LOAD '$LKP_db.sbnet_dev_connection_type' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_os = LOAD '$LKP_db.sbnet_dev_os' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_resolution = LOAD '$LKP_db.sbnet_dev_resolution' USING org.apache.hive.hcatalog.pig.HCatLoader();
...
STORE sbnet_denorm INTO '$TMP_db.sbnet_dev_denorm' USING org.apache.hive.hcatalog.pig.HCatStorer();
