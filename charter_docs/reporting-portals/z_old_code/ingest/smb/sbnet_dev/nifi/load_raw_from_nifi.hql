...
INSERT OVERWRITE TABLE sbnet_DEV_raw
SELECT 
  accept_language,
  browser,
  browser_height,
  ...
  yearly_visitor,
  zip
FROM nifi_sbnet_DEV_raw
WHERE (partition_date = '${env:RUN_DATE}')
  AND (${env:ENVIRONMENT}.epoch_converter(post_cust_hit_time_gmt*1000,'America/Denver') = DATE_ADD('${env:RUN_DATE}',-1));
; 