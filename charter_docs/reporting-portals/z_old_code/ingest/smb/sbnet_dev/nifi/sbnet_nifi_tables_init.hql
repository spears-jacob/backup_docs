...
CREATE TABLE IF NOT EXISTS nifi_sbnet_dev_event
(
  event_id int,
  detail string
) 
...
CREATE TABLE IF NOT EXISTS nifi_sbnet_dev_browser
(
  browser_id string,
  detail string
) 
...
CREATE TABLE IF NOT EXISTS nifi_sbnet_dev_country
(
  country_id int,
  detail string
) 
...
CREATE TABLE IF NOT EXISTS nifi_sbnet_dev_connection_type
(
...
CREATE TABLE IF NOT EXISTS nifi_sbnet_dev_javascript
(
  javascript_id int,
  detail string
) 
...
CREATE TABLE IF NOT EXISTS nifi_sbnet_dev_language
(
  language_id int,
  detail string
) 
...
CREATE TABLE IF NOT EXISTS nifi_sbnet_dev_os
(
  os_id int,
  detail string
) 
...
CREATE TABLE IF NOT EXISTS nifi_sbnet_dev_resolution
(
  resolution_id int,
  detail string
) 
...
CREATE TABLE IF NOT EXISTS nifi_sbnet_dev_search_engine
(
...
CREATE EXTERNAL TABLE IF NOT EXISTS ${env:TMP_db}.nifi_sbnet_dev_raw
(
...
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION '/apps/hive/warehouse/${env:TMP_db}.db/nifi_sbnet_dev_raw'
