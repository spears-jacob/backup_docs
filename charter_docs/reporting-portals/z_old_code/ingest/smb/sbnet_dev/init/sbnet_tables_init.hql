...
CREATE TABLE IF NOT EXISTS  ${env:TMP_db}.sbnet_DEV_raw
(
...
CREATE TABLE IF NOT EXISTS ${env:TMP_db}.sbnet_DEV_denorm
(
  unique_id String,
  rank_id BigInt,
  accept_language String,
...
CREATE TABLE IF NOT EXISTS ${env:TMP_db}.sbnet_DEV_calc
(
  unique_id String,
  visit_id String,
...
CREATE TABLE IF NOT EXISTS ${env:TMP_db}.sbnet_DEV_events_no_part
(
  domain STRING,
  customer STRING,
...
CREATE TABLE IF NOT EXISTS sbnet_dev_events
(
  domain STRING,
  customer STRING,
  received_timestamp BIGINT,
...
CREATE TABLE IF NOT EXISTS sbnet_dev_raw_history
(
  accept_language String,
  browser String,
  browser_height Int,
