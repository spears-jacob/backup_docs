...
raw_sbnet_bhn_de = LOAD '$TMP_db.sbnet_bhn_denorm' USING org.apache.hive.hcatalog.pig.HCatLoader();
raw_sbnet_bhn_calc = LOAD '$TMP_db.sbnet_bhn_calc' USING org.apache.hive.hcatalog.pig.HCatLoader();

raw_sbnet_bhn = JOIN raw_sbnet_bhn_de BY unique_id LEFT OUTER, raw_sbnet_bhn_calc BY unique_id;

raw_sbnet_bhn = FILTER raw_sbnet_bhn BY post_cust_hit_time_gmt IS NOT NULL;

sbnet_bhn_events = foreach raw_sbnet_bhn generate
      'video' as domain:chararray,
      'L-BHN' as customer:chararray,
      ...
      raw_sbnet_bhn_calc::visit_start_timestamp as visit__visit_start_timestamp:long,
      ...
      null as visit__application_details__referrer_link:chararray,
      ...
      post_evar56 as visit__account__enc_account_number:chararray,    -- account number
      ...
      post_evar53 as visit__account__enc_account_enc_billing_division:chararray,     -- SYS
      post_evar54 as visit__account__enc_account_billing_id:chararray,           -- PRIN
      post_evar55 as visit__account__enc_account_enc_billing_division_id:chararray,  -- AGENT
      ...
      ((post_prop2 is not null)?post_prop2:post_prop19) as visit__user__role:chararray,
      ...
      raw_sbnet_bhn_calc::message_name as message__name:chararray, --updated to reflect message__category logic for message__name. Exit Link and Custom links will now show URL in message__name.
      (int)raw_sbnet_bhn_calc::sequence_number as message__sequence_number:int,
      ...
      post_evar31 as state__content__identifiers__provider_asset_id:chararray,
      ...
      post_prop25 as state__content__details__title:chararray,
      ...
      ((post_evar24 is not null)?post_evar24:post_prop20) as state__view__current_page__page_name:chararray,
      post_prop6 as state__view__current_page__section:chararray,
      post_prop9 as state__view__current_page__sub_section:chararray, --site identifier (c9) which = custom conversion 9
      post_evar17 as state__view__current_page__page_id:chararray,
      ...
      post_evar28 as state__view__current_page__page_number:chararray,
      ...
      ((post_evar39 is not null)?post_evar39:((post_prop26 is not null)?post_prop26:((post_evar11 is not null)?post_evar11:((post_prop11 is not null)?post_prop11:((post_evar12 is not null)?post_evar12:((post_evar13 is not null)?post_evar13:((post_prop13 is not null)?post_prop13:post_evar45))))))) as state__view__current_page__elements__name:chararray,
      ...
      ((post_evar43 is not null)?post_evar43:post_evar44) as state__search__text:chararray,
...
-- DUMP sbnet_bhn_events $ENV;

STORE sbnet_bhn_events INTO '$TMP_db.sbnet_bhn_events_no_part' USING org.apache.hive.hcatalog.pig.HCatStorer();
