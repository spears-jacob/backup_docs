...
CREATE TABLE IF NOT EXISTS asp_sbnet_bhn_event
(
  event_id int,
  detail string
)
...
CREATE TABLE IF NOT EXISTS asp_sbnet_bhn_browser
(
  browser_id string,
  detail string
)
...
CREATE TABLE IF NOT EXISTS asp_sbnet_bhn_country
(
  country_id int,
  detail string
)
...
CREATE TABLE IF NOT EXISTS asp_sbnet_bhn_connection_type
(
...
CREATE TABLE IF NOT EXISTS asp_sbnet_bhn_javascript
(
  javascript_id int,
  detail string
)
...
CREATE TABLE IF NOT EXISTS asp_sbnet_bhn_language
(
  language_id int,
  detail string
)
...
CREATE TABLE IF NOT EXISTS asp_sbnet_bhn_os
(
  os_id int,
  detail string
)
...
CREATE TABLE IF NOT EXISTS asp_sbnet_bhn_resolution
(
  resolution_id int,
  detail string
)
...
CREATE TABLE IF NOT EXISTS asp_sbnet_bhn_search_engine
(
...
CREATE EXTERNAL TABLE IF NOT EXISTS asp_sbnet_bhn_raw
(
...
LINES TERMINATED BY '\n'
STORED AS TEXTFILE
LOCATION '/apps/hive/warehouse/${env:NIFI_db}.db/asp_sbnet_bhn_raw'
