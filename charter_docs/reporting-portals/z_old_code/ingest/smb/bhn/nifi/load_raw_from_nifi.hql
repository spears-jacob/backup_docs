...
INSERT OVERWRITE TABLE ${env:TMP_db}.sbnet_bhn_raw
SELECT
  accept_language,
  browser,
  browser_height,
  ...
  evar54,
  evar55,
  CASE WHEN evar56 rlike "[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]"
            THEN aes_encrypt256(evar56)
       ELSE aes_encrypt256(BHNDecrypt(evar56))
  END as evar56,
  evar57,
  evar58,
  evar59,
  ...
  post_evar54,
  post_evar55,
  CASE WHEN post_evar56 rlike "[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]"
            THEN aes_encrypt256(post_evar56)
       ELSE aes_encrypt256(BHNDecrypt(post_evar56))
  END as post_evar56,
  post_evar57,
  post_evar58,
  post_evar59,
