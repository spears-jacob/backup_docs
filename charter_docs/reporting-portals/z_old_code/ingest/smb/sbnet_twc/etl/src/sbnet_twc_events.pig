...
raw_sbnet_de = LOAD '$TMP_db.sbnet_twc_denorm' USING org.apache.hive.hcatalog.pig.HCatLoader();
raw_sbnet_calc = LOAD '$TMP_db.sbnet_twc_calc' USING org.apache.hive.hcatalog.pig.HCatLoader();
...
sbnet_events = foreach raw_sbnet generate
    ...
    TOMAP(
      ...
      --message.feature
      null as message__feature__name:chararray,
      ...
      --replaced post_evar47/post_prop47 definition with post_pagename definition below:
...
--			null as operation__selected__view_element_name:chararray,
      ((post_evar47 is not null)?post_evar47:post_prop47) as operation__selected__view_element_name:chararray,
...
STORE sbnet_events INTO '$TMP_db.sbnet_twc_events_no_part' USING org.apache.hive.hcatalog.pig.HCatStorer();
