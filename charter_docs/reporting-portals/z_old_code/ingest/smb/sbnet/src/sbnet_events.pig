...
raw_sbnet_de = LOAD '$TMP_db.sbnet_denorm' USING org.apache.hive.hcatalog.pig.HCatLoader();
raw_sbnet_calc = LOAD '$TMP_db.sbnet_calc' USING org.apache.hive.hcatalog.pig.HCatLoader();
...
sbnet_events = foreach raw_sbnet generate
            ...
            --Removed definition: null as visit__settings:map[chararray],
            ...
            ((post_prop8 is not null)?post_prop8:((post_prop16 is not null)?post_prop16:post_prop17)) as visit__application_details__referrer_link:chararray,
            ...
            (int)post_prop47 as state__view__current_page__page_load_time_ms:int,
...
STORE sbnet_events INTO '$TMP_db.sbnet_events_no_part' USING org.apache.hive.hcatalog.pig.HCatStorer();
