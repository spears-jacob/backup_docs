...
CREATE TABLE IF NOT EXISTS  ${env:TMP_db}.sbnet_twc_global_raw
(
...
CREATE TABLE IF NOT EXISTS ${env:TMP_db}.sbnet_twc_global_denorm
(
  unique_id String,
  rank_id BigInt,
  accept_language String,
...
CREATE TABLE IF NOT EXISTS ${env:TMP_db}.sbnet_twc_global_calc
(
  unique_id String,
  visit_id String,
...
CREATE TABLE IF NOT EXISTS ${env:TMP_db}.sbnet_twc_global_events_no_part
(
  domain STRING,
  customer STRING,
...
CREATE TABLE IF NOT EXISTS twcbusglobal_events
(
  domain STRING,
  customer STRING,
  received_timestamp BIGINT,
...
CREATE TABLE IF NOT EXISTS sbnet_twc_global_raw_history
(
  accept_language String,
  browser String,
  browser_height Int,
...
CREATE TABLE IF NOT EXISTS ${env:LKP_db}.sbnet_twc_global_custom_event(
  event_id int,
  detail string,
