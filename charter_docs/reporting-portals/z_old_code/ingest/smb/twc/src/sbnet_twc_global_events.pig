...
raw_sbnet_de = LOAD '$TMP_db.sbnet_twc_global_denorm' USING org.apache.hive.hcatalog.pig.HCatLoader();
raw_sbnet_calc = LOAD '$TMP_db.sbnet_twc_global_calc' USING org.apache.hive.hcatalog.pig.HCatLoader();
...
sbnet_events = foreach raw_sbnet generate
      ...
      post_evar56 as visit__application_details__referrer_link:chararray,
      ...
      (raw_sbnet_calc::message_name == 'My Account Login' ? post_cust_hit_time_gmt:null) as visit__login__login_completed_timestamp:long,
      --visit.video_zone
      ...
      post_evar75 as visit__account__enc_account_number:chararray,  -- account number
      ...
      post_prop35 as visit__account__subscription:chararray,
      null as visit__account__subscription__service_level:chararray,
      null as visit__account__status:chararray,
      post_prop72 as visit__account__enc_account_enc_billing_division:chararray,     -- SYS
      post_prop73 as visit__account__enc_account_billing_id:chararray,           -- PRIN
      post_prop74 as visit__account__enc_account_enc_billing_division_id:chararray,  -- AGENT
      ...
      post_evar83 as visit__user__role:chararray,
      ...
      post_evar55 as application__error__error_message:chararray,
      --application.api
      ...
      post_prop33 as message__triggered_by:chararray,
      --message.feature
      post_evar51 as message__feature__name:chararray,
      ...
      post_evar25 as state__content__stream__playback_id:chararray,
      ...
      --((post_prop2 is not null)?post_prop2:post_evar1) as --state__view__current_page__page_name:chararray,
      --replaced post_prop2 definition with post_pagename definition below:

      post_pagename as state__view__current_page__page_name:chararray,

      post_prop3 as state__view__current_page__section:chararray,
      ((post_page_event_var2 is not null)?post_page_event_var2:((post_evar57 is not null)?post_evar57:post_prop19)) as state__view__current_page__sub_section:chararray,
      post_prop65 as state__view__current_page__page_id:chararray,
      null as state__view__current_page__page_load_time_ms:int,

      ((post_prop34 is not null)?post_prop34:post_evar24) as state__view__current_page__page_type:chararray,
      ...
      --state.view.modal
      post_evar50 as state__view__modal__name:chararray,
      ...
      ((post_prop9 is not null)?post_prop9:post_evar9) as state__search__text:chararray,
      ...
      --replaced null field with old 'page name' definition below:
      --null as operation__selected__view_element_name:chararray,
      ((post_prop2 is not null)?post_prop2:post_evar1) as  operation__selected__view_element_name:chararray,
...
STORE sbnet_events INTO '$TMP_db.sbnet_twc_global_events_no_part' USING org.apache.hive.hcatalog.pig.HCatStorer();
