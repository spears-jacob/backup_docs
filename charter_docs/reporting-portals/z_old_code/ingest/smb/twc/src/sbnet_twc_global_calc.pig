...
raw_sbnet = LOAD '$TMP_db.sbnet_twc_global_denorm' USING org.apache.hive.hcatalog.pig.HCatLoader();

map_custom_event = LOAD '$LKP_db.sbnet_twc_global_custom_event' USING org.apache.hive.hcatalog.pig.HCatLoader();
...
raw_sbnet_short = FOREACH raw_sbnet GENERATE
    ...
    (chararray)(CASE post_page_event
     ...
     END) AS actual_message_name:chararray; --Better way to define message_name
...
raw_sbnet_calc = FOREACH raw_sbnet_short GENERATE
    ...
    raw_sbnet_short::actual_message_name AS actual_message_name_1:chararray;
...
raw_sbnet_final = FOREACH raw_sbnet_final_join GENERATE
    ...
    (chararray)raw_sbnet_calc::actual_message_name_1 AS message_name:chararray; -- updated 2018-03-07 DPrince

STORE raw_sbnet_final INTO '$TMP_db.sbnet_twc_global_calc' USING org.apache.hive.hcatalog.pig.HCatStorer();
