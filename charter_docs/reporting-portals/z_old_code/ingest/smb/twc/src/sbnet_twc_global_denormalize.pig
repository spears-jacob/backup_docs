...
raw_sbnet = LOAD '$TMP_db.sbnet_twc_global_raw' USING org.apache.hive.hcatalog.pig.HCatLoader();

-- loading of the tables
--Following tables are adobe generated
map_browser = LOAD '$LKP_db.sbnet_twc_global_browser' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_country = LOAD '$LKP_db.sbnet_twc_global_country' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_connection_type = LOAD '$LKP_db.sbnet_twc_global_connection_type' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_os = LOAD '$LKP_db.sbnet_twc_global_os' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_resolution = LOAD '$LKP_db.sbnet_twc_global_resolution' USING org.apache.hive.hcatalog.pig.HCatLoader();
...
raw_sbnet = JOIN raw_sbnet BY browser LEFT OUTER, map_browser BY browser_id  USING 'replicated';
raw_sbnet = JOIN raw_sbnet BY country LEFT OUTER, map_country BY country_id  USING 'replicated';
raw_sbnet = JOIN raw_sbnet BY connection_type LEFT OUTER,  map_connection_type BY connection_type_id  USING 'replicated';
raw_sbnet = JOIN raw_sbnet BY os LEFT OUTER, map_os BY os_id  USING 'replicated';
raw_sbnet = JOIN raw_sbnet BY resolution LEFT OUTER, map_resolution BY resolution_id  USING 'replicated';

raw_sbnet = rank raw_sbnet;

sbnet_denorm = FOREACH raw_sbnet GENERATE
...
STORE sbnet_denorm INTO '$TMP_db.sbnet_twc_global_denorm' USING org.apache.hive.hcatalog.pig.HCatStorer();
