...
DEFINE aes_encrypt com.spectrum.pig.udfs.AesEncrypt();

raw_data = LOAD '$TMP_db.$dbprefix_raw' USING org.apache.hive.hcatalog.pig.HCatLoader();

-- loading of the tables
--Following tables are adobe generated
map_browser = LOAD '$LKP_db.$dbprefix_browser' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_country = LOAD '$LKP_db.$dbprefix_country' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_connection_type = LOAD '$LKP_db.$dbprefix_connection_type' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_os = LOAD '$LKP_db.$dbprefix_os' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_resolution = LOAD '$LKP_db.$dbprefix_resolution' USING org.apache.hive.hcatalog.pig.HCatLoader();
...
raw_data = JOIN raw_data BY browser LEFT OUTER, map_browser BY browser_id  USING 'replicated';
raw_data = JOIN raw_data BY country LEFT OUTER, map_country BY country_id  USING 'replicated';
raw_data = JOIN raw_data BY connection_type LEFT OUTER,  map_connection_type BY connection_type_id  USING 'replicated';
raw_data = JOIN raw_data BY os LEFT OUTER, map_os BY os_id  USING 'replicated';
raw_data = JOIN raw_data BY resolution LEFT OUTER, map_resolution BY resolution_id  USING 'replicated';

raw_data = rank raw_data;

data_denorm = FOREACH raw_data GENERATE
    ...
    post_evar201 AS post_evar201:chararray,
    post_evar202 AS post_evar202:chararray,
    post_evar203 AS post_evar203:chararray,
    post_evar204 AS post_evar204:chararray,
    post_evar205 AS post_evar205:chararray,
    post_evar206 AS post_evar206:chararray,
    post_evar207 AS post_evar207:chararray,
    post_evar208 AS post_evar208:chararray,
    post_evar209 AS post_evar209:chararray,
    post_evar210 AS post_evar210:chararray,
    post_evar211 AS post_evar211:chararray,
    post_evar212 AS post_evar212:chararray,
    post_evar213 AS post_evar213:chararray,
    post_evar214 AS post_evar214:chararray,
    post_evar215 AS post_evar215:chararray,
    post_evar216 AS post_evar216:chararray,
    post_evar217 AS post_evar217:chararray,
    post_evar218 AS post_evar218:chararray,
    post_evar219 AS post_evar219:chararray,
    post_evar220 AS post_evar220:chararray,
    post_evar221 AS post_evar221:chararray,
    post_evar222 AS post_evar222:chararray,
    post_evar223 AS post_evar223:chararray,
    post_evar224 AS post_evar224:chararray,
    post_evar225 AS post_evar225:chararray,
    post_evar226 AS post_evar226:chararray,
    post_evar227 AS post_evar227:chararray,
    post_evar228 AS post_evar228:chararray,
    post_evar229 AS post_evar229:chararray,
    post_evar230 AS post_evar230:chararray,
    post_evar231 AS post_evar231:chararray,
    post_evar232 AS post_evar232:chararray,
    post_evar233 AS post_evar233:chararray,
    post_evar234 AS post_evar234:chararray,
    post_evar235 AS post_evar235:chararray,
    post_evar236 AS post_evar236:chararray,
    post_evar237 AS post_evar237:chararray,
    post_evar238 AS post_evar238:chararray,
    post_evar239 AS post_evar239:chararray,
    post_evar240 AS post_evar240:chararray,
    post_evar241 AS post_evar241:chararray,
    post_evar242 AS post_evar242:chararray,
    post_evar243 AS post_evar243:chararray,
    post_evar244 AS post_evar244:chararray,
    post_evar245 AS post_evar245:chararray,
    post_evar246 AS post_evar246:chararray,
    post_evar247 AS post_evar247:chararray,
    post_evar248 AS post_evar248:chararray,
    post_evar249 AS post_evar249:chararray,
    post_evar250 AS post_evar250:chararray,
...
STORE data_denorm INTO '$TMP_db.$dbprefix_denorm' USING org.apache.hive.hcatalog.pig.HCatStorer();
