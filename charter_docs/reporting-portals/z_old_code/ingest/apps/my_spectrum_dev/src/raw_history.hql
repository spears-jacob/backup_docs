...
SELECt "\n\nNow Inserting partitions into Raw History Table.\n\n";

INSERT OVERWRITE TABLE ${env:dbprefix_raw_history} partition(partition_date_utc, partition_date_hour_utc)
SELECT
    accept_language,
    aemassetid,
    aemassetsource,
