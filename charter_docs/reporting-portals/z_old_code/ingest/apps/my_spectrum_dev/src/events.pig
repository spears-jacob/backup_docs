...
raw_data_de = LOAD '$TMP_db.$dbprefix_denorm' USING org.apache.hive.hcatalog.pig.HCatLoader();
raw_calc = LOAD '$TMP_db.$dbprefix_calc' USING org.apache.hive.hcatalog.pig.HCatLoader();

raw_data = JOIN raw_data_de BY unique_id LEFT OUTER, raw_calc BY unique_id;

raw_data = FILTER raw_data BY post_cust_hit_time_gmt IS NOT NULL;

data_events = foreach raw_data generate
            '$domain' as domain:chararray,
            '$customer' as customer:chararray,
            ...
            raw_calc::visit_start_timestamp as visit__visit_start_timestamp:long,
      ...
      --visit settings map-of-everything
      TOMAP('post_prop1',(chararray)post_prop1,
            ...
            'post_evar201',(chararray)post_evar201,
            'post_evar202',(chararray)post_evar202,
            'post_evar203',(chararray)post_evar203,
            'post_evar204',(chararray)post_evar204,
            'post_evar205',(chararray)post_evar205,
            'post_evar206',(chararray)post_evar206,
            'post_evar207',(chararray)post_evar207,
            'post_evar208',(chararray)post_evar208,
            'post_evar209',(chararray)post_evar209,
            'post_evar210',(chararray)post_evar210,
            'post_evar211',(chararray)post_evar211,
            'post_evar212',(chararray)post_evar212,
            'post_evar213',(chararray)post_evar213,
            'post_evar214',(chararray)post_evar214,
            'post_evar215',(chararray)post_evar215,
            'post_evar216',(chararray)post_evar216,
            'post_evar217',(chararray)post_evar217,
            'post_evar218',(chararray)post_evar218,
            'post_evar219',(chararray)post_evar219,
            'post_evar220',(chararray)post_evar220,
            'post_evar221',(chararray)post_evar221,
            'post_evar222',(chararray)post_evar222,
            'post_evar223',(chararray)post_evar223,
            'post_evar224',(chararray)post_evar224,
            'post_evar225',(chararray)post_evar225,
            'post_evar226',(chararray)post_evar226,
            'post_evar227',(chararray)post_evar227,
            'post_evar228',(chararray)post_evar228,
            'post_evar229',(chararray)post_evar229,
            'post_evar230',(chararray)post_evar230,
            'post_evar231',(chararray)post_evar231,
            'post_evar232',(chararray)post_evar232,
            'post_evar233',(chararray)post_evar233,
            'post_evar234',(chararray)post_evar234,
            'post_evar235',(chararray)post_evar235,
            'post_evar236',(chararray)post_evar236,
            'post_evar237',(chararray)post_evar237,
            'post_evar238',(chararray)post_evar238,
            'post_evar239',(chararray)post_evar239,
            'post_evar240',(chararray)post_evar240,
            'post_evar241',(chararray)post_evar241,
            'post_evar242',(chararray)post_evar242,
            'post_evar243',(chararray)post_evar243,
            'post_evar244',(chararray)post_evar244,
            'post_evar245',(chararray)post_evar245,
            'post_evar246',(chararray)post_evar246,
            'post_evar247',(chararray)post_evar247,
            'post_evar248',(chararray)post_evar248,
            'post_evar249',(chararray)post_evar249,
            'post_evar250',(chararray)post_evar250,
            ...
            post_event_list as visit__application_details__referrer_link:chararray, -- event_list_lookup, with actual events:chararray,
            post_evar2 as visit__application_details__application_name:chararray, --version of app with build
            post_evar1 as visit__application_details__application_type:chararray, --either RES, SMB, or ENT
            post_evar4 as visit__application_details__app_version:chararray, -- OS version (iOS x.x, Android x.x)
            post_evar3 as visit__application_details__venona_version:chararray, -- count of downloads
            ...
            --visit.login
            (int)((post_prop65 matches '*loginError*')? 1:0) as visit__login__failed_attempts:int,
            ...
            ((post_evar75 is not null)?post_evar75:post_prop75) as visit__account__enc_account_number:chararray,
            ...
            --visit.user
            null as visit__user__enc_id:chararray,
            ...
            post_evar3 as visit__user__status:chararray,
            --vsit.location
            ...
            (chararray)(CASE post_page_event
              ...
              END) as message__category:chararray,
            raw_calc::message_name as message__name:chararray,
            (int)raw_calc::sequence_number as message__sequence_number:int,
            post_cust_hit_time_gmt as message__timestamp:long,
            null as message__triggered_by:chararray,
            --message.feature
            raw_calc::message_feature_name as message__feature__name:chararray,
            ...
            ((post_evar47 is not null)?post_evar47:post_prop47) as state__view__current_page__page_name:chararray,
            post_prop3 as state__view__current_page__section:chararray,
            ((post_prop63 is not null)?post_prop63:post_evar63) as state__view__current_page__sub_section:chararray,
            ((post_prop65 is not null)?post_prop65:post_evar65) as state__view__current_page__page_id:chararray,
            null as state__view__current_page__page_load_time_ms:int,

            post_evar9 as state__view__current_page__page_type:chararray,
            null as state__view__current_page__display_type:chararray,
            (chararray)visit_page_num as state__view__current_page__page_number:chararray,
            ...
            ((post_evar8 is not null)?post_evar8:post_prop8) as state__view__current_page__elements__name:chararray,
            ...
            post_prop59 as state__view__previous_page__page_name:chararray,
            post_evar59 as state__view__previous_page__section:chararray,
            ...
            null as state__search__text:chararray,
...
-- DUMP data_events $ENV;

STORE data_events INTO '$TMP_db.$dbprefix_events_no_part' USING org.apache.hive.hcatalog.pig.HCatStorer();
