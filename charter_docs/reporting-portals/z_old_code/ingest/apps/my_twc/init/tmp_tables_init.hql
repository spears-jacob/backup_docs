...
SELECt "\n\nNow Creating Temporary Tables if needed.\n\n";

CREATE TABLE IF NOT EXISTS ${env:dbprefix_raw}
(
...
CREATE TABLE IF NOT EXISTS ${env:dbprefix_denorm}
(
    unique_id String,
    rank_id BigInt,
    accept_language String,
...
CREATE TABLE IF NOT EXISTS ${env:dbprefix_calc}
(
    unique_id String,
    visit_id String,
...
CREATE TABLE IF NOT EXISTS ${env:dbprefix_events_no_part}
(
    domain STRING,
    customer STRING,
