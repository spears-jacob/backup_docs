...
raw_net = LOAD '$TMP.net_dev_denorm' USING org.apache.hive.hcatalog.pig.HCatLoader();
...
STORE raw_net_calc_f INTO '$TMP.net_dev_calc' USING org.apache.hive.hcatalog.pig.HCatStorer();
