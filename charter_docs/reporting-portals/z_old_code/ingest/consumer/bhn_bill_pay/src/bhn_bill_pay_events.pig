...
raw_sbnet_de = LOAD '$TMP_db.bhn_bill_pay_denorm' USING org.apache.hive.hcatalog.pig.HCatLoader();
raw_bhn_bill_pay_calc = LOAD '$TMP_db.bhn_bill_pay_calc' USING org.apache.hive.hcatalog.pig.HCatLoader();

raw_sbnet = JOIN raw_sbnet_de BY unique_id LEFT OUTER, raw_bhn_bill_pay_calc BY unique_id;
...
sbnet_events = foreach raw_sbnet generate
      ...
      raw_bhn_bill_pay_calc::visit_start_timestamp as visit__visit_start_timestamp:long,
      ...
      raw_bhn_bill_pay_calc::message_name as message__name:chararray,
      (int)raw_bhn_bill_pay_calc::sequence_number as message__sequence_number:int,
      post_cust_hit_time_gmt as message__timestamp:long,
      null as message__triggered_by:chararray,
      --message.feature
      raw_bhn_bill_pay_calc::message_feature_name as message__feature__name:chararray,
...
STORE sbnet_events INTO '$TMP_db.bhn_bill_pay_events_no_part' USING org.apache.hive.hcatalog.pig.HCatStorer();
