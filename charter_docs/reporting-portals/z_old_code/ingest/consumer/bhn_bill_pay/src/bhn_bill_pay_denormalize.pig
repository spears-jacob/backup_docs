...
raw_bhn_bill_pay = LOAD '$TMP_db.bhn_bill_pay_raw' USING org.apache.hive.hcatalog.pig.HCatLoader();

-- loading of the tables
--Following tables are adobe generated
map_browser = LOAD '$LKP_db.bhn_bill_pay_browser' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_country = LOAD '$LKP_db.bhn_bill_pay_country' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_connection_type = LOAD '$LKP_db.bhn_bill_pay_connection_type' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_os = LOAD '$LKP_db.bhn_bill_pay_os' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_resolution = LOAD '$LKP_db.bhn_bill_pay_resolution' USING org.apache.hive.hcatalog.pig.HCatLoader();
...
raw_bhn_bill_pay = JOIN raw_bhn_bill_pay BY browser LEFT OUTER, map_browser BY browser_id  USING 'replicated';
raw_bhn_bill_pay = JOIN raw_bhn_bill_pay BY country LEFT OUTER, map_country BY country_id  USING 'replicated';
raw_bhn_bill_pay = JOIN raw_bhn_bill_pay BY connection_type LEFT OUTER,  map_connection_type BY connection_type_id  USING 'replicated';
raw_bhn_bill_pay = JOIN raw_bhn_bill_pay BY os LEFT OUTER, map_os BY os_id  USING 'replicated';
raw_bhn_bill_pay = JOIN raw_bhn_bill_pay BY resolution LEFT OUTER, map_resolution BY resolution_id  USING 'replicated';

raw_bhn_bill_pay = rank raw_bhn_bill_pay;

bhn_bill_pay_denorm = FOREACH raw_bhn_bill_pay GENERATE
...
-- DUMP bhn_bill_pay_denorm;

STORE bhn_bill_pay_denorm INTO '$TMP_db.bhn_bill_pay_denorm' USING org.apache.hive.hcatalog.pig.HCatStorer();
