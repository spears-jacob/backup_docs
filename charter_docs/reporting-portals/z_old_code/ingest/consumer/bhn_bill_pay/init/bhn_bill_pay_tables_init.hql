...
CREATE TABLE IF NOT EXISTS ${env:TMP_db}.bhn_bill_pay_raw
(
...
CREATE TABLE IF NOT EXISTS ${env:TMP_db}.bhn_bill_pay_denorm
(
  unique_id String,
  rank_id BigInt,
  accept_language String,
...
CREATE TABLE IF NOT EXISTS ${env:TMP_db}.bhn_bill_pay_calc
(
  unique_id String,
  visit_id String,
...
CREATE TABLE IF NOT EXISTS ${env:TMP_db}.bhn_bill_pay_events_no_part
(
  domain STRING,
  customer STRING,
...
CREATE TABLE IF NOT EXISTS bhn_bill_pay_events
(
  domain STRING,
  customer STRING,
  received_timestamp BIGINT,
...
CREATE TABLE IF NOT EXISTS bhn_bill_pay_raw_history
(
  accept_language String,
  aemassetid String,
  aemassetsource String,
