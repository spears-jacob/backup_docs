...
raw_net_de = LOAD '$TMP.net_denorm' USING org.apache.hive.hcatalog.pig.HCatLoader();
raw_net_calc = LOAD '$TMP.net_calc' USING org.apache.hive.hcatalog.pig.HCatLoader();
...
net_events = foreach raw_net generate
      ...
      post_prop3 as visit__isp__status:chararray, --in Omniture: Login Status (3), either 'Logged Out' or 'Logged In'
      --visit.connection
      ...
      ((post_prop55 is not null)?post_prop55:post_evar55) as state__view__current_page__search_text:chararray, --state.view.current_page.search_text
      ...
      post_prop52 as state__view__modal__text:chararray, --state.view.modal.text
      ...
      post_prop51 as operation__user_entry__enc_text:chararray, --operation.user_entry.text
      post_prop23 as operation__user_entry__type:chararray; --operation.user_entry.type

-- DUMP net_events $ENV;

STORE net_events INTO '$TMP.net_events_no_part' USING org.apache.hive.hcatalog.pig.HCatStorer();
