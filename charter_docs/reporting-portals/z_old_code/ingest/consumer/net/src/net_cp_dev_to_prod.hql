...
INSERT INTO TABLE net_events PARTITION (partition_date)
SELECT 
  domain,
  customer,
  received_timestamp,
...
FROM
  net_dev_events
WHERE 
  (partition_date_utc between '${env:YESTERDAY_DEN}' and '${env:TODAY_DEN}')                     
  AND (epoch_converter(cast(message__timestamp*1000 as bigint),'America/Denver') = '${env:YESTERDAY_DEN}' 
  AND state__view__current_page__section = "Voice Online Manager")
;
