...
raw_sbnet_de = LOAD '$TMP_db.bhn_residential_denorm' USING org.apache.hive.hcatalog.pig.HCatLoader();
raw_sbnet_calc = LOAD '$TMP_db.bhn_residential_calc' USING org.apache.hive.hcatalog.pig.HCatLoader();
...
sbnet_events = foreach raw_sbnet generate
      ...
      post_evar5  as visit__account__enc_account_number:chararray,     -- account number
      ...
      post_evar38 as visit__account__enc_account_enc_billing_division:chararray,     -- SYS
      post_evar39 as visit__account__enc_account_billing_id:chararray,           -- PRIN
      post_evar9  as visit__account__enc_account_enc_billing_division_id:chararray,  -- AGENT
      ...
      ((post_prop1 is not null)?post_prop1:post_evar1) as visit__location__region:chararray,
      ...
      --application.error
      post_evar48 as application__error__error_type:chararray,
      null as application__error__error_code:chararray,
      null as application__error__error_extras:map[chararray],
      post_prop44 as application__error__error_message:chararray,
      --application.api
      ...
      --message.feature
      raw_sbnet_calc::message_feature_name as message__feature__name:chararray,
      ...
      ((post_pagename is not null)?post_pagename:((post_prop8 is not null)?post_prop8:post_evar8)) as state__view__current_page__page_name:chararray,
      ((post_channel is not null)?post_channel:((post_prop6 is not null)?post_prop6:post_evar6)) as state__view__current_page__section:chararray,
      ((post_prop7 is not null)?post_prop7:post_evar7) as state__view__current_page__sub_section:chararray,
      ((post_evar17 is not null)?post_evar17:post_evar15) as state__view__current_page__page_id:chararray,
      null as state__view__current_page__page_load_time_ms:int,
      post_page_type as state__view__current_page__page_type:chararray,
      post_evar9 as state__view__current_page__display_type:chararray, -- Site identifier, 2017-12-21
      ...
      null as state__view__current_page__elements__name:chararray,
      ...
      null as state__view__previous_page__page_name:chararray,
      null as state__view__previous_page__section:chararray,
      null as state__view__previous_page__sub_section:chararray,
      post_evar16 as state__view__previous_page__page_id:chararray,
      null as state__view__previous_page__page_viewed_time_sec:int,
      null as state__view__previous_page__page_load_time_ms:int,
      --state.view.modal
      ((post_evar20 is not null)?post_evar20:((post_evar19 is not null)?post_evar19:((post_evar29 is not null)?post_evar29:((post_evar32 is not null)?post_evar32:post_evar33)))) as state__view__modal__name:chararray,
      ...
      ((post_evar11 is not null)?post_evar11:((post_evar12 is not null)?post_evar12:((post_prop11 is not null)?post_prop11:post_prop12))) as state__search__text:chararray,
      ...
      post_evar14 as state__search__search_id:chararray,
      --operation
...
STORE sbnet_events INTO '$TMP_db.bhn_residential_events_no_part' USING org.apache.hive.hcatalog.pig.HCatStorer();
