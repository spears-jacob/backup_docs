...
raw_bhn_residential = LOAD '$TMP_db.bhn_residential_raw' USING org.apache.hive.hcatalog.pig.HCatLoader();

-- loading of the tables
--Following tables are adobe generated
map_browser = LOAD '$LKP_db.bhn_residential_browser' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_country = LOAD '$LKP_db.bhn_residential_country' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_connection_type = LOAD '$LKP_db.bhn_residential_connection_type' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_os = LOAD '$LKP_db.bhn_residential_os' USING org.apache.hive.hcatalog.pig.HCatLoader();
map_resolution = LOAD '$LKP_db.bhn_residential_resolution' USING org.apache.hive.hcatalog.pig.HCatLoader();
...
raw_bhn_residential = JOIN raw_bhn_residential BY browser LEFT OUTER, map_browser BY browser_id  USING 'replicated';
raw_bhn_residential = JOIN raw_bhn_residential BY country LEFT OUTER, map_country BY country_id  USING 'replicated';
raw_bhn_residential = JOIN raw_bhn_residential BY connection_type LEFT OUTER,  map_connection_type BY connection_type_id  USING 'replicated';
raw_bhn_residential = JOIN raw_bhn_residential BY os LEFT OUTER, map_os BY os_id  USING 'replicated';
raw_bhn_residential = JOIN raw_bhn_residential BY resolution LEFT OUTER, map_resolution BY resolution_id  USING 'replicated';

raw_bhn_residential = rank raw_bhn_residential;

bhn_residential_denorm = FOREACH raw_bhn_residential GENERATE
...
-- DUMP bhn_residential_denorm;

STORE bhn_residential_denorm INTO '$TMP_db.bhn_residential_denorm' USING org.apache.hive.hcatalog.pig.HCatStorer();
