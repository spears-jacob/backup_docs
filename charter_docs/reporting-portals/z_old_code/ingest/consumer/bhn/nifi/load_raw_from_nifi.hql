...
INSERT OVERWRITE TABLE ${env:TMP_db}.bhn_residential_raw
SELECT
  accept_language,
  aemassetid,
  aemassetsource,
  ...
  evar3,
  evar4,
  CASE WHEN evar5 rlike "[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]"
            THEN aes_encrypt256(evar5)
       ELSE aes_encrypt256(BHNDecrypt(evar5))
  END as  evar5,
  evar6,
  evar7,
  evar8,
  ...
  post_evar3,
  post_evar4,
  CASE WHEN post_evar5 rlike "[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]"
            THEN aes_encrypt256(post_evar5)
       ELSE aes_encrypt256(BHNDecrypt(post_evar5))
  END as  post_evar5,
  post_evar6,
  post_evar7,
  post_evar8,
  ...
  yearly_visitor,
  zip
FROM nifi.asp_bhn_residential_raw
WHERE (partition_date = '${env:RUN_DATE}')
  AND (${env:ENVIRONMENT}.epoch_converter(post_cust_hit_time_gmt*1000,'America/New_York') = DATE_ADD('${env:RUN_DATE}',-1));
;
