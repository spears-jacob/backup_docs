...
CREATE TABLE IF NOT EXISTS ${env:TMP_db}.twc_residential_global_raw
(
...
CREATE TABLE IF NOT EXISTS ${env:TMP_db}.twc_residential_global_denorm
(
  unique_id String,
  rank_id BigInt,
  accept_language String,
...
CREATE TABLE IF NOT EXISTS ${env:TMP_db}.twc_residential_global_denorm_all_files
(
  unique_id String,
  rank_id BigInt,
  accept_language String,
...
CREATE TABLE IF NOT EXISTS ${env:TMP_db}.twc_residential_global_calc
(
  unique_id String,
  visit_id String,
...
CREATE TABLE IF NOT EXISTS ${env:TMP_db}.twc_residential_global_calc_combined_events
(
  unique_id String,
  visit_id String,
  previous_visit_id String,
  ...
  visit_start_timestamp Bigint,
  message_name String,
  message_feature_name ARRAY<STRING>
)
row format delimited fields terminated by '\t'
lines terminated by '\n'
stored as textfile TBLPROPERTIES('serialization.null.format'='');

CREATE TABLE IF NOT EXISTS ${env:TMP_db}.twc_residential_global_events_no_part
(
  domain STRING,
  customer STRING,
  ...
  message__feature__name ARRAY<STRING>,
...
CREATE TABLE IF NOT EXISTS twc_residential_global_events
(
  domain STRING,
  customer STRING,
  received_timestamp BIGINT,
...
CREATE TABLE IF NOT EXISTS twc_residential_global_raw_history
(
  accept_language String,
  aemassetid String,
  aemassetsource String,
