...
INSERT OVERWRITE TABLE twc_residential_global_raw_history partition(partition_date_utc, partition_date_hour_utc)
SELECT 
  accept_language,
  aemassetid,
  aemassetsource,
...
FROM ${env:TMP_db}.twc_residential_global_raw; 