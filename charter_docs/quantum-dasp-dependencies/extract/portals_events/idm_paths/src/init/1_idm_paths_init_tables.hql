...
create table IF NOT EXISTS asp_idm_paths_metrics (
  platform string,
  referrer_link string,
  browser_name string,
  device_type string,
...
SELECT "\n\nFor creating views\n\n";
create VIEW IF NOT EXISTS asp_v_idm_paths_flow AS
SELECT *
    FROM asp_idm_paths_flow;

create VIEW IF NOT EXISTS asp_v_idm_paths_time AS
SELECT *
    FROM asp_idm_paths_time;

create VIEW IF NOT EXISTS asp_v_idm_paths_metrics AS
SELECT *
    FROM asp_idm_paths_metrics;
