...
INSERT overwrite TABLE asp_specmobile_events PARTITION(PARTITION_DATE_ET,PARTITION_DATE_HOUR_ET)
Select
  domain,
  customer,
  received__timestamp,
  ...
  prod.epoch_converter(received__timestamp,'America/New_York') partition_date_et,
  prod.epoch_datehour (received__timestamp,'America/New_York') partition_date_hour_et
