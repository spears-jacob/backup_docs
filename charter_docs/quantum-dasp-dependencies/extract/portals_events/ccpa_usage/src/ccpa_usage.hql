...
INSERT OVERWRITE TABLE ccpa.asp_usage_ccpa_daily_table_a PARTITION (denver_date)
SELECT
...
INSERT OVERWRITE TABLE ccpa.asp_usage_ccpa_daily_table_b PARTITION (denver_date)
SELECT
  visit__account__enc_account_number               AS account,
  visit__account__enc_account_billing_division_id  AS billing_division_id,
  visit__account__enc_account_billing_division     AS billing_division,
...
INSERT OVERWRITE TABLE ccpa.asp_usage_ccpa_daily_table_c PARTITION (denver_date)
SELECT
  visit__account__enc_account_number               AS account,
  visit__account__enc_account_billing_division_id  AS billing_division_id,
  visit__account__enc_account_billing_division     AS billing_division,
