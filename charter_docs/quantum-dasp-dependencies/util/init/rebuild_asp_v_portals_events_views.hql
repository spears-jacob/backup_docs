...
show create table asp_v_venona_staging_portals_idm;
...
alter view asp_v_venona_staging_portals_idm as select * from prod.venona_events_staging where  visit__application_details__application_name = 'IDManagement';
