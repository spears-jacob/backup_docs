...
module "sg_zod_ddl_manager" {
  ...
  db_table_name_to_config_map = module.sg_zod_tables_configuration.db_table_name_to_config_map
}

module "sg_zod_tables_configuration" {
  source = "../../configuration"
  env = var.env
}

module "sg_zod_init_s3_buckets" {
