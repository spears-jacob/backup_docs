...
module "ipv_ddl_manager" {
  ...
  db_table_name_to_config_map = module.ipv_tables_configuration.db_table_name_to_config_map
}

module "ipv_tables_configuration" {
  source = "../../configuration"
  env = var.env
}

module "ipv_init_s3_buckets" {
