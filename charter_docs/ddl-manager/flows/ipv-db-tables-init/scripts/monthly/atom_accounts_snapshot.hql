-- TODO I think it shouldn't placed here, because of this job reads data from this table, not write, but currently this table should be created for job completion
