...
module "global_ddl_manager" {
  ...
  db_table_name_to_config_map = module.global_tables_configuration.db_table_name_to_config_map
}

module "global_tables_configuration" {
  source = "../../configuration"
  env = var.env
}

module "global_init_s3_buckets" {
