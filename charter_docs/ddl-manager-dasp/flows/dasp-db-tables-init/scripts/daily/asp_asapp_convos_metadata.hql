CREATE EXTERNAL TABLE IF NOT EXISTS ${db_name}.asp_asapp_convos_metadata (
...
-- todo: find a way to specify prod bucket which should be used here
-- 's3://pi-qtm-dasp-prod-aggregates-nopii/data/prod/asp_asapp_convos_metadata'
