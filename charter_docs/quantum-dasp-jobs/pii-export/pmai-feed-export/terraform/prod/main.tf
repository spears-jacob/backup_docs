...
module "job" {
  ...
  read_db_table_names = [
    "prod_dasp.asp_pmai_sia_device_out"
  ]
  write_db_table_names = [
    "prod_dasp.app_figures_downloads",
    "prod_dasp.app_figures_ranks",
    "prod_dasp.app_figures_sentiment"
  ]
  step_scripts = {
  ...
  write_kms_key = "arn:aws:kms:us-east-1:387455165365:key/d68e75a8-e9b7-4557-af3e-16967d19bf47"
