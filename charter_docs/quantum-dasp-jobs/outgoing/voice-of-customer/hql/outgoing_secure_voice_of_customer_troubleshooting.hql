...
SELECT DISTINCT
       denver_date
      ,datetime_denver
      ,aes_decrypt256(visit__account__enc_account_number, 'aes256') as account_number
      ,aes_decrypt256(visit__account__enc_account_billing_id, 'aes256') as billing_id
      ,visit__visit_id
...
from asp_extract_voice_of_customer_troubleshooting
