...
module "job" {
  ...
  write_db_table_names = [
    ...
    "prod_dasp.si_composite_score_kpi_dist_daily",
    "prod_dasp.si_composite_score_kpi_agg_daily",
    "prod_dasp.si_cross_platform",
    "prod_dasp.si_composite_score_kpi_agg_visit_daily",
    "prod_dasp.si_core_quantum_events",
    "prod_dasp.si_summary_tableau"
  ]
  step_scripts = {
