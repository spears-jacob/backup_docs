...
export PRIOR_8DAYS_LAST_MONTH_START_DATE_TZ=$(TZ=UTC date -d "$PRIOR_8DAYS_LAST_MONTH_START_DATE `TZ="$2" date -d "$PRIOR_8DAYS_LAST_MONTH_START_DATE" +%Z`" +%Y-%m-%d_%H)
export PRIOR_8DAYS_LAST_MONTH_END_DATE_TZ=$(TZ=UTC date -d "$PRIOR_8DAYS_LAST_MONTH_END_DATE `TZ="$2" date -d "$PRIOR_8DAYS_LAST_MONTH_END_DATE" +%Z`" +%Y-%m-%d_%H)
