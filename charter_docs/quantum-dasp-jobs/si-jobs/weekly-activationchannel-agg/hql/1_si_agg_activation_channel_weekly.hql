...
and event_case_id in ('selfInstall_error_verifyEquipmentSetup','selfInstall_error_deviceQualification_nonCOAM','selfInstall_error_deviceQualification_blacklistedCOAM','selfInstall_error_deviceQualification_minimallyQualifiedCOAM','selfInstall_error_missingEquipment','selfInstall_error_verifyDeviceOnline','selfInstall_error_verifyDeviceSignal','selfInstall_error_LOBOutage','selfInstall_error_acceptTermsConditions','selfInstall_error_portPhoneTransfer','selfInstall_error_callUs','selfInstall_error_tryAgain')) web 
 on web.acct_id=a.acct_id and a.application_group=web.application_group
)  fn
