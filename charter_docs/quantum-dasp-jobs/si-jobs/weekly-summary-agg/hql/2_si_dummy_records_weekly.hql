...
DROP TABLE IF EXISTS ${env:TMP_db}.si_summary_dummy_weekly PURGE;
CREATE TABLE IF NOT EXISTS ${env:TMP_db}.si_summary_dummy_weekly AS
...
FROM ${env:TMP_db}.si_summary_dummy_weekly dummy
