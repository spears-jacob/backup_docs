...
module "job" {
  ...
  write_db_table_names = [
    "stg_dasp.cs_site_section_call_in_rate",
    "stg_dasp.cs_page_view_call_in_rate",
    "stg_dasp.cs_call_in_rate",
    "stg_dasp.cs_calls_with_prior_visits",
    "stg_dasp.cs_calls_with_prior_visits_agg"
  ]
  step_scripts = {
    "1 - cs-page-view" = "1_cs_page_view-${var.job_version}",
