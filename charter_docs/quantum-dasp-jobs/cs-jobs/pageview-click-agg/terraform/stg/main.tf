...
module "job" {
  ...
  write_db_table_names = [
    "stg_dasp.cs_calendar_monthly_pageview_selectaction_aggregate",
    "stg_dasp.cs_selectaction_aggregate",
    "stg_dasp.cs_dates",
    "stg_dasp.cs_daily_pageview_selectaction_aggregate",
    "stg_dasp.cs_monthly_pageview_selectaction_aggregate",
    "stg_dasp.cs_weekly_pageview_selectaction_aggregate",
    "stg_dasp.chtr_fiscal_month"
  ]
  step_scripts = {
