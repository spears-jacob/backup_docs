...
DROP TABLE IF EXISTS ${env:TMP_db}.asp_msa_onboarding_flow_daily;

CREATE TEMPORARY table if not exists ${env:TMP_db}.asp_msa_onboarding_flow_daily
 ROW FORMAT SERDE 'org.apache.hadoop.hive.ql.io.orc.OrcSerde'
 STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
 OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
 LOCATION 'hdfs:///tmp/tmp_msa_onboarding/asp_msa_onboarding_flow_daily'
...
select
  ...
  FROM
      (select date_denver,
         ...
         from ${env:TMP_db}.asp_msa_onboarding_flow_daily
