...
DROP TABLE IF EXISTS ${env:TMP_db}.asp_quantum_msa_onboarding_metrics_preliminary_weekly;
CREATE TABLE ${env:TMP_db}.asp_quantum_msa_onboarding_metrics_preliminary_weekly
(
  mso STRING,
  device_type STRING,
...
LOCATION 'hdfs:///tmp/tmp_msa_onboarding/asp_quantum_msa_onboarding_metrics_preliminary_weekly'
TBLPROPERTIES('orc.compress'='snappy')
;

INSERT INTO TABLE ${env:TMP_db}.asp_quantum_msa_onboarding_metrics_preliminary_weekly
SELECT
        mso,
        device_type,
        tutorial_completed,
...
SELECT  mso,
        ...
        label_date_denver,
        grain
FROM ${env:TMP_db}.asp_quantum_msa_onboarding_metrics_preliminary_weekly
;
