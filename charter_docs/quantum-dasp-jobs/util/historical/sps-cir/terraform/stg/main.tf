...
module "job" {
  ...
  write_db_table_names = [
    "stg_dasp.cs_site_section_call_in_rate_sps",
    "stg_dasp.cs_page_view_call_in_rate_sps",
    "stg_dasp.cs_call_in_rate_sps",
    "stg_dasp.cs_calls_with_prior_visits_sps",
    "stg_dasp.cs_calls_with_prior_visits_agg_sps"
  ]
  step_scripts = {
