...
#  "prod_mob.mvno_accounts",
  ...
  write_db_table_names = [
    "prod_dasp.mvno_sspp_activity"
  ]

  step_scripts = {
    "1 - mvno_sspp_activity" = "1_mvno_sspp_activity-${var.job_version}" #,  add this back in once tableau is ready
#    "2 - tableau-refresh" = "2_tableau_refresh-${var.job_version}" add this back in once Tableau is ready
  }
