...
module "job" {
  ...
  read_db_table_names = [
    ...
    "stg_dasp.asp_quality_kpi_core",
    "stg_dasp.asp_quality_kpi_dist",
    "stg_dasp.asp_quality_kpi_mos",
  ...
  write_db_table_names = [
    ...
    "stg_dasp.asp_quality_kpi_dist",
    "stg_dasp.asp_quality_kpi_mos",
    "stg_dasp.asp_quality_visit_agg",
    "stg_dasp.asp_quality_bucket_distribution"
  ]
  step_scripts = {
