...
-- building temporary results table for a single insert at the end
-- this alleviates file and folder splintering and allows union all to function
DROP TABLE IF EXISTS ${env:TMP_db}.kmb_dasp_quality_kpi_${env:CLUSTER};

CREATE TEMPORARY TABLE ${env:TMP_db}.kmb_dasp_quality_kpi_${env:CLUSTER} AS
SELECT 'total' as timeframe,
       application_name,
       metric_name,
       metric_value,
       denver_date
...
----Active HHs (All)
INSERT INTO ${env:TMP_db}.kmb_dasp_quality_kpi_${env:CLUSTER}
SELECT
  'total' as timeframe,
...
FROM(
  ...
  FROM
    (
      ...
      FROM
        ${env:ENVIRONMENT}.core_quantum_events_sspp
...
DROP TABLE IF EXISTS ${env:TMP_db}.kmb_dasp_application_entry_events_${env:CLUSTER} PURGE;

CREATE TEMPORARY TABLE IF NOT EXISTS ${env:TMP_db}.kmb_dasp_application_entry_events_${env:CLUSTER}
    ROW FORMAT SERDE 'org.apache.hadoop.hive.ql.io.orc.OrcSerde'
    STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
        OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
    LOCATION 'hdfs:///tmp/tmp_dasp_quality/kmb_dasp_application_entry_events'
    TBLPROPERTIES('orc.compress'='snappy') AS
SELECT
  epoch_converter(MIN(received__timestamp),'America/Denver') AS denver_date,
  t1.visit_id,
  t1.application_name,
  t1.application_type,
...
DROP TABLE IF EXISTS ${env:TMP_db}.kmb_dasp_application_entry_${env:CLUSTER} PURGE;

CREATE TEMPORARY TABLE IF NOT EXISTS ${env:TMP_db}.kmb_dasp_application_entry_${env:CLUSTER}
    ROW FORMAT SERDE 'org.apache.hadoop.hive.ql.io.orc.OrcSerde'
    STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
        OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
    LOCATION 'hdfs:///tmp/tmp_dasp_quality/kmb_dasp_application_entry'
    TBLPROPERTIES('orc.compress'='snappy') AS
SELECT
  denver_date,
  visit_id,
...
FROM ${env:TMP_db}.kmb_dasp_application_entry_events_${env:CLUSTER}
;
...
FROM (
  ...
  FROM ${env:TMP_db}.kmb_dasp_application_entry_${env:CLUSTER}
) AS t1
GROUP BY
application_name,
denver_date
...
DROP TABLE IF EXISTS ${env:TMP_db}.kmb_dasp_otp_experience_events_${env:CLUSTER} PURGE;

CREATE TEMPORARY TABLE IF NOT EXISTS ${env:TMP_db}.kmb_dasp_otp_experience_events_${env:CLUSTER}
 ROW FORMAT SERDE 'org.apache.hadoop.hive.ql.io.orc.OrcSerde'
 STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
 OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
 LOCATION 'hdfs:///tmp/tmp_dasp_quality/kmb_dasp_otp_experience_events'
 TBLPROPERTIES('orc.compress'='snappy') AS
WITH temp AS(
  SELECT DISTINCT
  ...
  FROM (
    ...
    WHERE partition_date_hour_utc >= '${hiveconf:START_DATE_TZ}'
      AND partition_date_hour_utc <  '${hiveconf:END_DATE_TZ}'
      AND visit__application_details__application_name IN ('SpecNet','SMB','MySpectrum','SpecMobile')
      AND(
...
DROP TABLE IF EXISTS ${env:TMP_db}.kmb_dasp_otp_experience_pages_${env:CLUSTER} PURGE;

CREATE TEMPORARY TABLE IF NOT EXISTS ${env:TMP_db}.kmb_dasp_otp_experience_pages_${env:CLUSTER}
 ROW FORMAT SERDE 'org.apache.hadoop.hive.ql.io.orc.OrcSerde'
 STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
 OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
 LOCATION 'hdfs:///tmp/tmp_dasp_quality/kmb_dasp_otp_experience_pages'
 TBLPROPERTIES('orc.compress'='snappy') AS
SELECT
  denver_date,
  t1.application_name,
...
JOIN ${env:TMP_db}.kmb_dasp_otp_experience_events_${env:CLUSTER} AS t2
ON t1.visit_id = t2.visit_id
AND t1.application_name = t2.application_name
GROUP BY
  denver_date,
...
DROP TABLE IF EXISTS ${env:TMP_db}.kmb_dasp_otp_experience_${env:CLUSTER} PURGE;

CREATE TEMPORARY TABLE IF NOT EXISTS ${env:TMP_db}.kmb_dasp_otp_experience_${env:CLUSTER}
 ROW FORMAT SERDE 'org.apache.hadoop.hive.ql.io.orc.OrcSerde'
 STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
 OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
 LOCATION 'hdfs:///tmp/tmp_dasp_quality/kmb_dasp_otp_experience'
 TBLPROPERTIES('orc.compress'='snappy') AS
SELECT
  denver_date,
  application_name,
...
FROM ${env:TMP_db}.kmb_dasp_otp_experience_pages_${env:CLUSTER};
...
FROM (
  ...
  FROM ${env:TMP_db}.kmb_dasp_otp_experience_${env:CLUSTER}
) AS t1
GROUP BY
denver_date,
application_name
...
DROP TABLE IF EXISTS ${env:TMP_db}.kmb_dasp_autopay_experience_events_${env:CLUSTER} PURGE;

CREATE TEMPORARY TABLE IF NOT EXISTS ${env:TMP_db}.kmb_dasp_autopay_experience_events_${env:CLUSTER}
ROW FORMAT SERDE 'org.apache.hadoop.hive.ql.io.orc.OrcSerde'
STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
LOCATION 'hdfs:///tmp/tmp_dasp_quality/kmb_dasp_autopay_experience_events'
TBLPROPERTIES('orc.compress'='snappy') AS
WITH temp AS(
  SELECT DISTINCT
    MIN(t1.denver_date) OVER (PARTITION BY t1.visit_id) AS denver_date,
...
DROP TABLE IF EXISTS ${env:TMP_db}.kmb_dasp_autopay_experience_pages_${env:CLUSTER} PURGE;

CREATE TEMPORARY TABLE IF NOT EXISTS ${env:TMP_db}.kmb_dasp_autopay_experience_pages_${env:CLUSTER}
 ROW FORMAT SERDE 'org.apache.hadoop.hive.ql.io.orc.OrcSerde'
 STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
 OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
 LOCATION 'hdfs:///tmp/tmp_dasp_quality/kmb_dasp_autopay_experience_pages'
 TBLPROPERTIES('orc.compress'='snappy') AS
SELECT
  denver_date,
  t1.application_name,
...
JOIN ${env:TMP_db}.kmb_dasp_autopay_experience_events_${env:CLUSTER} AS t2
ON t1.visit_id = t2.visit_id
AND t1.application_name = t2.application_name
GROUP BY
  denver_date,
...
DROP TABLE IF EXISTS ${env:TMP_db}.kmb_dasp_autopay_experience_${env:CLUSTER} PURGE;

CREATE TEMPORARY TABLE IF NOT EXISTS ${env:TMP_db}.kmb_dasp_autopay_experience_${env:CLUSTER}
ROW FORMAT SERDE 'org.apache.hadoop.hive.ql.io.orc.OrcSerde'
STORED AS INPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcInputFormat'
OUTPUTFORMAT 'org.apache.hadoop.hive.ql.io.orc.OrcOutputFormat'
LOCATION 'hdfs:///tmp/tmp_dasp_quality/kmb_dasp_autopay_experience'
TBLPROPERTIES('orc.compress'='snappy') AS
SELECT
  denver_date,
  application_name,
  ...
  END AS page_load_sec_bucket
FROM ${env:TMP_db}.kmb_dasp_autopay_experience_pages_${env:CLUSTER};
...
FROM (
  ...
  FROM ${env:TMP_db}.kmb_dasp_autopay_experience_${env:CLUSTER}
) AS t1
GROUP BY
denver_date,
application_name
...
INSERT OVERWRITE  asp_quality_kpi PARTITION(denver_date)
SELECt * FROM ${env:TMP_db}.kmb_dasp_quality_kpi_${env:CLUSTER};
...
DROP TABLE IF EXISTS ${env:TMP_db}.kmb_dasp_autopay_experience_pages_${env:CLUSTER}  PURGE;
DROP TABLE IF EXISTS ${env:TMP_db}.kmb_dasp_autopay_experience_${env:CLUSTER}        PURGE;
DROP TABLE IF EXISTS ${env:TMP_db}.kmb_dasp_quality_kpi_${env:CLUSTER}               PURGE;
