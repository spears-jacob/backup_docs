...
module "job" {
  ...
  read_db_table_names = [
    "stg_dasp.asp_m2dot0_metric_agg",
    "stg_dasp.cs_calls_with_prior_visits_prod_copy",
    "stg_dasp.mvno_avgperlinecount_buckets_prod_copy",
    "stg_dasp.asp_m2dot0_visitsRanked"
    ### "prod.core_quantum_events_sspp",
  ]
  write_db_table_names = [
    "stg_dasp.asp_m2dot0_visitsRanked",
    "stg_dasp.asp_m2dot0_CIRagg",
    "stg_dasp.asp_m2dot0_engagedHouseholds",
    "stg_dasp.asp_m2dot0_metric_visit_lookup",
    "stg_dasp.asp_m2dot0_apiRaw",
    "stg_dasp.asp_m2dot0_apiagg",
    "stg_dasp.asp_m2dot0_apiJoin",
    "stg_dasp.asp_m2dot0_apiFinal"
  ]
  step_scripts = {
