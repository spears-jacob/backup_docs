...
CREATE TABLE IF NOT EXISTS quantum_set_agg_portals_m2dot0
(
  mso STRING,
...
select *
from prod.quantum_set_agg_portals_m2dot0;
...
FROM quantum_set_agg_portals_m2dot0
...
FROM quantum_set_agg_portals_m2dot0
where `quantum_set_agg_portals_m2dot0`.`application_name` IN ('myspectrum', 'specnet', 'smb')
and grouping_id IN ('2049','2051','2081','2083','2561','2563','2593','2595')
and `quantum_set_agg_portals_m2dot0`.`label_date_denver` >= '2018-08-22'
AND
    (
