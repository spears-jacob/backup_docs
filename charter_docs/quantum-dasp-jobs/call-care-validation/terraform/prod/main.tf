...
module "job" {
  ...
  write_db_table_names = [
    "prod_dasp.cs_call_care_data_sun",
    "prod_dasp.cs_call_care_data_mon",
    "prod_dasp.cs_call_care_data_tue",
    "prod_dasp.cs_call_care_data_wed",
    "prod_dasp.cs_call_care_data_thu",
    "prod_dasp.cs_call_care_data_fri",
    "prod_dasp.cs_call_care_data_sat"
  ]
  step_scripts = {
    "1 - cs-call-care-validation" = var.job_version
  }
