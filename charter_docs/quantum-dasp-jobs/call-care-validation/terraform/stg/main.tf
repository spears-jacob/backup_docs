...
module "job" {
  ...
  write_db_table_names = [
    "stg_dasp.cs_call_care_data_sun",
    "stg_dasp.cs_call_care_data_mon",
    "stg_dasp.cs_call_care_data_tue",
    "stg_dasp.cs_call_care_data_wed",
    "stg_dasp.cs_call_care_data_thu",
    "stg_dasp.cs_call_care_data_fri",
    "stg_dasp.cs_call_care_data_sat"
  ]
  step_scripts = {
    "1 - call-care-validation" = var.job_version
  }
