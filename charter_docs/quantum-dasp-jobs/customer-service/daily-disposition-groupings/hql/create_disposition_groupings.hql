...
insert overwrite table ${env:DASP_db}.cs_dispositions_issue_groups
select
distinct
issue_description
,id_form
...
from ${env:DASP_db}.cs_dispositions
union all
select
distinct
issue_description
...
insert overwrite table ${env:DASP_db}.cs_dispositions_cause_groups
select
distinct
cause_description
,cd_form
...
insert overwrite table ${env:DASP_db}.cs_dispositions_resolution_groups
select
distinct
