...
hive -v -e "CREATE VIEW IF NOT EXISTS ${DASP_db}.portals_quantum_tableau_daily_agg_v AS SELECT
...
FROM ${DASP_db}.quantum_set_agg_portals
...
SELECT
   ...
   'Prod Monthly'     AS \"Metric Feature\",
...
SELECT
  ...
  END AS \"Metric Re-Name\",
   ...
   'CX Monthly Metrics'   AS \"Metric Feature\",

unit_type AS Aggregation


FROM ${DASP_db}.quantum_set_agg_portals
where \"quantum_set_agg_portals\".\"application_name\" IN ('myspectrum', 'specnet', 'smb')
and grouping_id IN ('2049','2051','2081','2083','2561','2563','2593','2595')
and \"quantum_set_agg_portals\".\"label_date_denver\" >= '2018-08-22'
AND
    (
...
hive -v -e "CREATE VIEW IF NOT EXISTS ${DASP_db}.portals_quantum_tableau_ss_summary AS
SELECT
  \"Application Type\",
  \"Metric Name\",
  \"Metric Re-Name\",
...
FROM ${DASP_db}.portals_quantum_tableau_daily_agg_v
WHERE
  Type = 'Monthly'
