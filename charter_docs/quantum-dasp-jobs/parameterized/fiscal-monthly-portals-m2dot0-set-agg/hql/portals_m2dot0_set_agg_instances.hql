...
FROM
  (
  SELECT
    'teehee' as unit_type, -- 8192
    unit_identifier, -- 4096
  ...
  FROM
    ...
    SELECT
      ...
      CUSTOM_visit__application_details__app_version,
      agg_custom_visit__account__details__service_subscriptions,
      agg_custom_visit__account__details__service_subscriptions_other,
      agg_custom_visit__account__details__service_subscriptions_core,
      agg_custom_visit__account__details__service_subscriptions_mobile,
      agg_custom_customer_group,
      agg_custom_visit__account__configuration_factors,
