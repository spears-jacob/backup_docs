...
-------------------------------------------------------------------------------
-------------------------------------------------------------------------------
INSERT INTO ${env:TMP_db}.m2dot0_set_agg_portals_stage_visits_${hiveconf:execid}_${hiveconf:stepid}
SELECT
...
CASE WHEN (grouping_id & 1) = 0 THEN agg_visit__account__configuration_factors ELSE 'All migration status' END AS agg_visit__account__configuration_factors,
  ...
  unit_type,
  IF('visits'='visits',cast(metric_calls as string),cast(NULL as string)) as call_count_24h,
  partition_date_utc,
