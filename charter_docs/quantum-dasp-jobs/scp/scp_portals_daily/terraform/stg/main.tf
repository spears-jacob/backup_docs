...
module "job" {
  ...
  write_db_table_names = [
    "stg_dasp.asp_scp_portals_acct_agg",
    "stg_dasp.asp_scp_portals_action",
    "stg_dasp.asp_scp_portals_actions_agg",
    "stg_dasp.asp_scp_portals_billing_agg",
    "stg_dasp.asp_scp_portals_subscriber_agg"
  ]
  step_scripts = {
