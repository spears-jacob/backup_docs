...
awsconfigfile = os.environ['HOME'] + '/.aws/credentials'
...
if assertion == '':
    ...
    credentials["token"] = input("VIP-Token: ")
...
#Joey's copy to PV e0001
copy_to_pv = input('copy to pv: ')
...
for awsrole in awsroles:
    ...
    if account_number in account_aliases:
        role_item['accountName'] = account_aliases[account_number] 
...
if copy_to_pv == 'yes':
    bashCommand = "scp " + awsconfigfile + "  e0001:.aws/credentials"
