...
Select  account_number
	...
	from
  	( Select
	    ...
	    where partition_date_hour_utc >= '2019-03-01' AND
...
LEFT JOIN dev.cs_historical_snapshot_logins_17142 old
   ON  old.account_number=new.account_number
WHERE old.account_number IS NULL
AND new.account_number in ('8245116813904093')
--limit 10
;
