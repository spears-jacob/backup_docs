...
INSERT OVERWRITE TABLE dev.cs_prod_monthly_fiscal_month_metrics PARTITION (fiscal_month = '${hiveconf:FISCAL_MONTH}')
SELECT
 "cir" as metric
...
INSERT INTO TABLE dev.cs_prod_monthly_fiscal_month_metrics PARTITION (fiscal_month = '${hiveconf:FISCAL_MONTH}')
SELECT
 "dfcr" as metric
