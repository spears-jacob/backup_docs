CREATE TABLE IF NOT EXISTS ${env:TMP_db}.cs_care_events_Legacy
(
...
CREATE TABLE IF NOT EXISTS ${env:ENVIRONMENT}.cs_calls_with_prior_visit_Legacy
(
  account_number string,
...
CREATE TABLE IF NOT EXISTS ${env:ENVIRONMENT}.cs_visit_rate_4calls_Legacy
(
  agent_mso string
  ,visit_type string
  ,customer_type string
...
CREATE TABLE IF NOT EXISTS ${env:ENVIRONMENT}.cs_calls_with_visits_Legacy
(
  account_number string
  ,customer_type string
  ,customer_subtype string
