...
CREATE TABLE IF NOT EXISTS ${env:TMP_db}.steve_care_events
(
...
CREATE TABLE IF NOT EXISTS ${env:ENVIRONMENT}.steve_calls_with_prior_visit
(
  account_number string,
...
CREATE TABLE IF NOT EXISTS ${env:ENVIRONMENT}.steve_visit_rate_4calls
(
  agent_mso string
  ,visit_type string
  ,customer_type string
...
CREATE TABLE IF NOT EXISTS ${env:ENVIRONMENT}.steve_calls_with_visits
(
  account_number string
  ,customer_type string
  ,customer_subtype string
